    ...
    <div class="page-enter min-h-screen flex flex-col">
      ...
      <main class="flex-1 max-w-6xl mx-auto px-6 py-12 w-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ${z(`/nominal-roll`,`📜`,`Nominal Roll`,u,l)}
          ${z(`/submit`,`📝`,`Submit Nomination`,m,p)}
          ${z(`/find`,`🔍`,`Find My Nomination`,`Retrieve and print your submitted nomination form.`,`<span class="badge bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 text-[10px]">🔍 Lookup</span>`)}
          ${z(`/withdraw`,`↩️`,`Withdraw Nomination`,y,v)}
          ${z(`/valid-list`,`✅`,`Valid Nominations`,`List of verified candidates before withdrawal.`,b)}
          ${z(`/final-list`,`🏆`,`Final Candidate List`,`Approved final candidate list for ballot.`,x)}
          ${z(`/results`,`📊`,`Live Results`,T,w)}
        </div>
      </main>
  ...
  `,t,i),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`));try{let[i,a,o,s,c]=await Promise.all([C.getNominalRoll(),C.getPosts().catch(()=>null),C.getPublicNominations().catch(()=>[]),C.getPublicSchedule().catch(()=>({})),C.getSettings().catch(()=>({}))]);if(B=Array.isArray(i)?i:[],ye=Array.isArray(o)?o:[],be=s||{},B.length===0)throw Error(`Nominal roll is empty. Please contact the admin.`);ve=Array.isArray(a)&&a.length>0?a:n.DEFAULT_POSTS,Ce(e,t,r,c||{})}catch(t){e.querySelector(`#loadingState`).innerHTML=`
    ...
    <form id="nomForm" class="space-y-8">
      ...
      <div>
        ...
        <select id="postSelect" class="field">${le(ve).map(e=>`<option value="${N(e.post)}">${N(e.post)}</option>`).join(``)}</select>
...
Do you want to proceed and print the blank form?`)&&ge(e)}function Te(e,t,n){let r=document.getElementById(`findSerialModalContainer`);r&&r.remove();let i=document.createElement(`div`);i.id=`findSerialModalContainer`,i.className=`fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm page-enter`,i.innerHTML=`
  ...
  </div>`}function De(e,t){let n=e.querySelector(`#serial-${t}`)?.value.trim(),r=e.querySelector(`#details-${t}`);if(!r)return;let i=B.find(e=>String(e[`Nominal Roll Serial Number`]||e.serial_number||``)===n);if(!i){r.innerHTML=n?`
  ...
  `,t,r),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`));try{let t=await C.getValidNominations();Le(e.querySelector(`main`),t)}catch{Le(e.querySelector(`main`),[])}}function Le(e,t){if(!t||t.length===0){e.innerHTML=`
    ...
    <div class="page-enter space-y-10">
      ...
      <div class="space-y-12">
        ${Object.keys(n).sort(ce).map(e=>{let t=n[e]||[];return t.sort((e,t)=>String(e.candidateName||``).localeCompare(String(t.candidateName||``))),`
  ...
  `,t,r),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`));try{let n=await C.getFinalNominations();Be(e.querySelector(`main`),n?.active||[],t)}catch{Be(e.querySelector(`main`),[],t)}}function Be(e,t,n){if(!t||t.length===0){e.innerHTML=`
    ...
    <div class="page-enter space-y-10">
      ...
      <div class="space-y-12">
        ${Object.keys(r).sort(ce).map(e=>{let t=r[e]||[];return t.sort((e,t)=>String(e.candidateName||``).localeCompare(String(t.candidateName||``))),`
          <div class="glass rounded-2xl overflow-hidden shadow-2xl border border-white/5">
...
Do you want to proceed and print the blank form?`)&&_e(e)}function Ge(e,t,r=null){let i=A(),a=t.candidate?.NAME||t.candidateName||`N/A`,o=t.candidate?.CLASS||t.candidateClass||`N/A`,s=t.candidate?.Dept||t.candidateDept||`N/A`;return`
  ...
  </div>`,e.querySelectorAll(`[data-admin-nav]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.adminNav;if(t===`public`){o.navigate(`/`);return}o.navigate(`/admin/${t}`)})}),e.querySelector(`#logoutBtn`).addEventListener(`click`,async()=>{try{let e=localStorage.getItem(`adminPwd`);e&&await C.adminLogout(e)}catch(e){console.error(`Logout API failed:`,e)}localStorage.removeItem(`adminPwd`),localStorage.removeItem(`adminLoginDate`),localStorage.removeItem(`adminSessionToken`),sessionStorage.removeItem(`adminSessionToken`),F(`Logged out.`,`info`),o.navigate(`/`)})}function W(e,t,n,r){return`
  <button data-admin-nav="${e}" class="sidebar-item ${r===e?`active`:``}">
    <span>${t}</span> ${n}
  </button>`}async function Qe(e){let t=H();if(t){U(e,`dashboard`,`
  ...
  `);try{let n=await C.adminGetNominations(t,!0);rt(e.querySelector(`#adminMain`),n,t)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${N(t.message)}</div>`}}}function rt(e,t,n){let r=Array.isArray(t)?t:[],i=r.filter(e=>e.withdrawalStatus&&e.withdrawalStatus!==`None`),a=r.filter(e=>e.status===`Valid`&&e.withdrawalStatus!==`Approved`),o=r.filter(e=>e.withdrawalStatus===`Approved`);e.innerHTML=`
    <div class="page-enter space-y-4">
      <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-2">
        <div>
          ...
          ${m===`dept`?`
            <div>
              ...
              <select id="printDeptSelect" class="field text-sm bg-slate-800 border-white/10 text-white w-full">
                ${f.map(t=>{let n=e.filter(e=>(e.Dept||``).trim().toLowerCase()===t.toLowerCase()).length;return`<option value="${N(t)}" ${t===h?`selected`:``}>${N(t)} (${n} students)</option>`}).join(``)}
              </select>
            </div>
          `:``}
            ...
            <div class="space-y-3">
              <div>
                ...
                <select id="printClassDeptFilter" class="field text-sm bg-slate-800 border-white/10 text-white w-full">
                  ...
                  ${f.map(e=>`<option value="${N(e)}" ${e===h?`selected`:``}>${N(e)}</option>`).join(``)}
                </select>
              </div>
              ...
              <div>
                ...
                <select id="printClassSelect" class="field text-sm bg-slate-800 border-white/10 text-white w-full">
                  ${n.map(t=>{let n=e.filter(e=>(e.CLASS||``).trim().toLowerCase()===t.toLowerCase()).length;return`<option value="${N(t)}" ${t===_?`selected`:``}>${N(t)} (${n} students)</option>`}).join(``)}
                </select>
              </div>
            </div>
          `:``}
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div>
            ...
            <select id="printSortSelect" class="field text-xs bg-slate-800 border-white/10 text-white w-full py-2">
              <option value="dept-class" ${v===`dept-class`?`selected`:``}>🏢 Dept ➔ Class ➔ Name (A-Z)</option>
              <option value="serial" ${v===`serial`?`selected`:``}>🔢 By Serial Number</option>
              <option value="class" ${v===`class`?`selected`:``}>🎓 By Class & Alphabetical</option>
            </select>
          </div>
          ...
          <div>
            ...
            <select id="printColumnsSelect" class="field text-xs bg-slate-800 border-white/10 text-white w-full py-2">
              <option value="1" ${y===`1`?`selected`:``}>1 Column (Standard)</option>
              <option value="2" ${y===`2`?`selected`:``}>2 Columns (Saves Space / Paper)</option>
            </select>
          </div>
          ...
          <div>
            ...
            `:`
              <label class="flex items-center gap-2 p-2 rounded-lg bg-slate-800/60 border border-white/5 cursor-pointer hover:bg-slate-800 h-[38px]">
                <input type="checkbox" id="pageBreakCheckbox" class="rounded text-indigo-600" ${b?`checked`:``}>
  ...
  `),y.document.close()}async function ct(e){let t=H();t&&(U(e,`publish`,`
...
Do you want to proceed and save this change to the database?`,!confirm(i))return}else if(!confirm(`Confirm setting total polling booths to ${n} and saving to database?`))return;if(n>m.length)for(let e=m.length;e<n;e++)m.push({boothNumber:e+1,roomName:``,classes:[]});else n<m.length&&(m=m.slice(0,n));try{await C.adminSaveBooths(t,m),await C.adminSaveLocations(t,h),F(`✅ Total booths updated to ${n} and saved to database!`,`success`)}catch(e){F(`Failed to persist to database: ${e.message}`,`error`)}v()}),e.querySelectorAll(`.room-name-select`).forEach(e=>{e.addEventListener(`change`,async e=>{let n=e.target.value,r=parseInt(e.target.dataset.idx,10);if(n===`__ADD_NEW__`){e.target.value=m[r].roomName||``,u();let t=a.querySelector(`#newLocationInput`);t&&t.focus();return}if(!n&&m[r].roomName){let t=m[r].roomName;if(!confirm(`Remove assigned room location "${t}" from Booth ${r+1}?`)){e.target.value=t;return}}m[r].roomName=n;try{await C.adminSaveBooths(t,m),await C.adminSaveLocations(t,h),F(`✅ Booth ${r+1} location saved as "${n||`Unassigned`}".`,`success`)}catch(e){F(`Failed to save location: ${e.message}`,`error`)}v()})}),e.querySelectorAll(`.quick-edit-loc-btn`).forEach(e=>{e.addEventListener(`click`,e=>{let t=parseInt(e.currentTarget.dataset.idx,10),n=m[t]?.roomName;if(!n)return;let r=h.indexOf(n);if(u(),r!==-1){g=r,S();let e=a.querySelector(`.loc-edit-input[data-idx="${r}"]`);e&&(e.focus(),e.select())}})});let a=e.querySelector(`#locationsModal`),l=()=>{let e=a.querySelector(`#newLocationInput`);e&&e.value.trim()&&!confirm(`You have entered an unadded location. Discard it?`)||(g=null,a.classList.add(`hidden`),v())},u=()=>{a.classList.remove(`hidden`),S()},d=async e=>{let n=a.querySelector(`.loc-edit-input[data-idx="${e}"]`);if(!n)return;let r=n.value.trim();if(!r){F(`Location name cannot be blank.`,`error`),n.focus();return}let i=h[e];if(r===i){g=null,S();return}if(h.some((t,n)=>n!==e&&t.toLowerCase()===r.toLowerCase())){F(`Location "${r}" already exists.`,`error`),n.focus();return}let o=m.filter(e=>e.roomName===i).length;if(o>0&&!confirm(`Confirm renaming location "${i}" to "${r}"?\n\nThis will update ${o} booth assignment(s).`)){n.value=i;return}h[e]=r,m.forEach(e=>{e.roomName===i&&(e.roomName=r)}),g=null,S();try{await C.adminSaveLocations(t,h),o>0&&await C.adminSaveBooths(t,m),F(`✅ Renamed to "${r}" and saved to database.`,`success`)}catch(e){F(`Failed to save rename: ${e.message}`,`error`)}},S=()=>{let e=a.querySelector(`#locationsCountBadge`);e&&(e.textContent=`${h.length} Locations`);let n=a.querySelector(`#locationsList`);if(!h.length){n.innerHTML=`<div class="p-6 text-center text-slate-500 text-sm italic bg-black/20 rounded-xl border border-white/5">No locations added yet. Add your rooms and halls above.</div>`;return}n.innerHTML=h.map((e,t)=>{let n=m.filter(t=>t.roomName===e);return g===t?`
      ...
      </div>`}),d):`<div class="alert alert-error">❌ Master Ballot Plan not generated.</div>`},x=()=>{m.forEach(e=>{e.classes=[],e.totalStudents=0});let e=m.length;if(e===0)return;let t={};p.forEach(e=>{t[e.dept]||(t[e.dept]={name:e.dept,total:0,classes:[]}),t[e.dept].classes.push(e),t[e.dept].total+=e.count});let n=r.length/e,i=Math.max(n*1.35,120);Object.values(t).sort((e,t)=>t.total-e.total).forEach(t=>{m.sort((e,t)=>e.totalStudents-t.totalStudents);let n=m[0];e>1&&t.total>i?[...t.classes].sort((e,t)=>t.count-e.count).forEach(e=>{m.sort((e,t)=>e.totalStudents-t.totalStudents),m[0].classes.push(e.name),m[0].totalStudents+=e.count}):(t.classes.forEach(e=>n.classes.push(e.name)),n.totalStudents+=t.total)}),m.sort((e,t)=>e.boothNumber-t.boothNumber)};v()}async function _t(e){let t=H();if(t){U(e,`counting`,`
  ...
  `);try{let[n,r,i,a,o,s]=await Promise.all([C.adminGetCountingMatrix(t,!0).catch(()=>null),C.getPosts(),C.adminGetNominations(t).catch(()=>[]),C.adminGetBooths(t),C.getNominalRoll(),C.adminGetSettings(t).catch(()=>({}))]),c=(Array.isArray(i)?i:[]).filter(e=>e.status===`Valid`&&e.withdrawalStatus!==`Approved`);vt(e.querySelector(`#adminMain`),t,n,r,c,a,o,s)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${N(t.message)}</div>`}}}function vt(e,t,r,i,a,o,s,c={}){let l=c?.collegeName||n.COLLEGE_NAME||`Government Victoria College Palakkad`,u=c?.electionYear||new Date().getFullYear().toString(),d=c?.collegeLogo||``;if(!o.length){e.innerHTML=`<div class="alert alert-error">❌ No booths configured.</div>`;return}if(!i.length){e.innerHTML=`<div class="alert alert-error">❌ No posts configured.</div>`;return}let f=e=>String(e.post||e.name||``),p=t=>{let{matrix:n,formSerials:r,totalRounds:s,roundLabels:c}=t,p=o.length;e.innerHTML=`
    ...
    `,e.querySelector(`#btnInitialGenerate`).addEventListener(`click`,m))}function yt(e,t,r,i,a,o=n.COLLEGE_NAME||`Government Victoria College Palakkad`,s=``,c=``){let l=s||new Date().getFullYear().toString(),u=i.length?i.map((e,t)=>`<tr>
  ...
  </div>`}var X=[],bt=!1,xt=null;window.addEventListener(`beforeunload`,e=>{X.some(e=>e.status===`pending`||e.status===`syncing`||e.status===`retry`)&&(e.preventDefault(),e.returnValue=`You have unsaved forms syncing in the background. Are you sure you want to leave?`)});function St(e){X.forEach(t=>{t.payload&&t.payload.forEach(t=>{let n=e.findIndex(e=>String(e.TableNumber)===String(t.TableNumber)&&String(e.Post)===t.Post&&e.CandidateId===t.CandidateId);n>=0?(e[n].Votes=t.Votes,e[n].RoundNumber=t.RoundNumber,e[n].FormSerial=t.FormSerial):e.push({...t})})})}async function Ct(e){let t=H();if(t){U(e,`results-entry`,`
  ...
  `;let m=e.querySelector(`#txtSerial`),h=e.querySelector(`#btnLoadBySerial`),g=async()=>{let r=m.value.trim();if(!r)return;let i=f[r];if(!i){F(`Invalid Serial Number: ${r}`,`error`);return}try{P(h,!0,`Loading...`),C.invalidateCache(`adminGetResults`);let o=await C.adminGetResults(t,!0).catch(()=>[]);a.length=0,a.push(...o),St(a),_(n[i.t].boothNumber,i.postName,r,i.r+1),Z(e,a,p)}catch{St(a),_(n[i.t].boothNumber,i.postName,r,i.r+1),Z(e,a,p)}finally{P(h,!1,`Load Form`)}};h.addEventListener(`click`,g),m.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),g())}),m.addEventListener(`keypress`,e=>{e.key===`Enter`&&g()}),e.querySelector(`#btnLoadForm`).addEventListener(`click`,async()=>{let r=e.querySelector(`#selTable`).value,i=e.querySelector(`#selPost`).value;if(!r||!i){F(`Select Table and Post`,`warning`);return}let o=n.findIndex(e=>String(e.boothNumber)===String(r)),s=null,c=null;if(o>=0){for(let e=0;e<u[o].length;e++)if(l(u[o][e])===i){c=e+1,s=d[`${o}-${e}`];break}}try{P(e.querySelector(`#btnLoadForm`),!0,`...`),C.invalidateCache(`adminGetResults`);let n=await C.adminGetResults(t,!0).catch(()=>[]);a.length=0,a.push(...n),St(a),_(r,i,s,c),Z(e,a,p)}catch{St(a),_(r,i,s,c),Z(e,a,p)}finally{P(e.querySelector(`#btnLoadForm`),!1,`Load`)}});let _=(n,r,o,s)=>{let l=e.querySelector(`#entryFormArea`),u=i.filter(e=>e.post===r).sort((e,t)=>String(e.candidateName||``).localeCompare(String(t.candidateName||``)));if(u.length===0){l.innerHTML=`<div class="alert alert-warning">No candidates found for ${N(r)}.</div>`;return}if(u.length===1){l.innerHTML=`
    ...
    >${e}</button>`}).join(``),r.querySelectorAll(`button[data-serial]`).forEach(r=>{r.addEventListener(`click`,()=>{let i=r.dataset.id;if(i){let r=X.find(e=>e.id===i);r&&(r.status=`retry`,Z(e,t,n),Tt(e,t,n))}let a=r.dataset.serial,o=e.querySelector(`#txtSerial`),s=e.querySelector(`#btnLoadBySerial`);o&&a&&(o.value=a,s?s.click():o.dispatchEvent(new KeyboardEvent(`keypress`,{key:`Enter`,bubbles:!0})),e.querySelector(`#entryFormArea`)?.scrollIntoView({behavior:`smooth`,block:`start`}))})});let g=e.querySelector(`#pendingList`),_=e.querySelector(`#pendingTabCount`),v=s.filter(e=>(o[String(e)]||`pending`)===`pending`);if(_&&(_.textContent=v.length),g&&(v.length===0?g.innerHTML=`<tr><td colspan="3" class="px-3 py-8 text-center text-slate-500 italic text-sm">🎉 All forms entered!</td></tr>`:(g.innerHTML=v.map(e=>{let t=n[String(e)]||{};return`
  ...
  `);let r=e.querySelector(`#adminMain`),i=[],a=null;try{let[e,n,r]=await Promise.all([C.adminGetPosts(t).catch(()=>[]),C.adminGetBallotConfig(t).catch(()=>null),C.adminGetBallotPlan(t).catch(()=>null)]);i=le(e),a=n}catch(e){console.warn(`Error fetching initial ballot data:`,e)}let o=e=>{let t=String(e.post||e.name||``).toUpperCase();return t.includes(`ASSOCIATION`)||t.includes(`ASSOC`)||!!e.deptRestriction},s=e=>{let t=String(e.post||e.name||``).toUpperCase();return t.includes(`UUC`)||t.includes(`UNIVERSITY UNION COUNCILLOR`)},c=e=>{if(o(e)||s(e))return!1;let t=String(e.post||e.name||``).toUpperCase();return t.includes(`REPRESENTATIVE`)||t.includes(`REP`)},l=e=>!o(e)&&!c(e),u=i.filter(l),d=e=>{let t=String(e||``).toLowerCase();return t.includes(`chairman`)&&!t.includes(`vice`)?`🏆`:t.includes(`vice chairman`)?`🥈`:t.includes(`joint secretary`)?`🤝`:t.includes(`secretary`)&&!t.includes(`fine arts`)?`📝`:t.includes(`councillor`)||t.includes(`uuc`)?`🏛️`:t.includes(`editor`)?`📰`:t.includes(`fine arts`)||t.includes(`arts`)?`🎨`:t.includes(`captain`)||t.includes(`sports`)?`⚽`:`🎖️`},f=[{id:`gen_1`,partNumber:1,title:`General Union Posts - Main`,shortCode:`G1`,bookPrefix:`GB1-`,paperSize:`A3`,posts:[]},{id:`gen_2`,partNumber:2,title:`Additional General Ballot (Arts, Sports & Editorial)`,shortCode:`G2`,bookPrefix:`GB2-`,paperSize:`A3`,posts:[]}],p=a||{isSplit:!1,ballots:f};(!Array.isArray(p.ballots)||p.ballots.length===0)&&(p.ballots=f),p.ballots.length===1&&p.ballots.push({id:`gen_2`,partNumber:2,title:`Additional General Ballot (Arts, Sports & Editorial)`,shortCode:`G2`,bookPrefix:`GB2-`,paperSize:`A3`,posts:[]});let m=new Set;p.isSplit&&p.ballots[1]&&Array.isArray(p.ballots[1].posts)&&p.ballots[1].posts.forEach(e=>m.add(e));let h=()=>{let e=m.size>0;p.isSplit=e;let t=u.map(e=>e.post),n=t.filter(e=>m.has(e)),r=t.filter(e=>!m.has(e));p.ballots[0].posts=r,p.ballots[0].shortCode=e?`G1`:`G`,p.ballots[0].bookPrefix=e?`GB1-`:`GB`,p.ballots[1]||(p.ballots[1]={id:`gen_2`,partNumber:2,title:`Additional General Ballot (Arts, Sports & Editorial)`,shortCode:`G2`,bookPrefix:`GB2-`,paperSize:`A3`,posts:[]}),p.ballots[1].posts=n,p.ballots[1].shortCode=`G2`,p.ballots[1].bookPrefix=`GB2-`};h();let g=()=>{let e=!!p.isSplit,t=p.ballots[0].posts||[],n=p.ballots[1]&&p.ballots[1].posts||[];r.innerHTML=`
    ...
    `),t.document.close()},y=async(e=`all`)=>{let r,i,a,s;try{[r,i,a,s]=await Promise.all([C.adminGetPosts(t),C.adminGetFinalNominations(t).catch(async()=>{let e=await C.adminGetNominations(t).catch(()=>[]);return{active:e.filter(e=>e.status!==`Rejected`&&e.withdrawalStatus!==`Approved`),withdrawn:e.filter(e=>e.withdrawalStatus===`Approved`),isPublished:!1}}),C.getPublicSchedule(),C.adminGetSettings(t).catch(()=>({}))])}catch(e){throw Error(e.message.includes(`not published`)?`Final List Not Published. Please finalize and publish the list first.`:e.message)}let u=s.collegeName||n.COLLEGE_NAME;s.collegeShortName||n.COLLEGE_SHORT_NAME;let d=s.collegeLogo||``,f=s.electionYear||a.electionYear||new Date().getFullYear().toString(),m=Array.isArray(i)?i:i?.active||[];if(m.length===0)throw Error(`No active candidates found. Please ensure candidates are nominated and verified.`);let h=r.filter(e=>m.filter(t=>t.post===e.post).length>1),g=!!p.isSplit,_=``,v=(e,t)=>{if(!t||t.length===0)return``;let n=(e.paperSize||`A3`).toLowerCase(),r=e.shortCode===`G`?`G`:(e.shortCode||`G1`)+`-`,i=e.title||`OFFICIAL BALLOT PAPER (GENERAL)`,a=[...t].sort((e,t)=>{let n=e.post.toLowerCase(),r=t.post.toLowerCase();return n.includes(`chairman`)&&!n.includes(`vice`)?-1:r.includes(`chairman`)&&!r.includes(`vice`)?1:n.includes(`vice chairman`)?-1:r.includes(`vice chairman`)||n.includes(`university union councillor`)||n.includes(`uuc`)?1:r.includes(`university union councillor`)||r.includes(`uuc`)?-1:0}),o=``,s=``;return a.forEach((e,t)=>{let n=m.filter(t=>t.post===e.post).sort((e,t)=>String(e.candidateName||``).localeCompare(String(t.candidateName||``))),r=`
      ...
      `)}catch(e){F(e.message,`error`)}};g()}function Dt(e){let t=H();if(!t)return;U(e,`testing`,`
...
Are you absolutely sure?`))return;P(t,!0,`🗑️ Wiping...`);let i=n.querySelector(`#wipeStatus`);i.innerHTML=``;try{await C.adminWipeData(r),n.querySelector(`#wipePasswordInput`).value=``,i.innerHTML=`
        ...
        </div>`,F(`All data wiped successfully.`,`success`)}catch(e){i.innerHTML=`<div class="alert alert-error mt-3">❌ ${N(e.message)}</div>`,F(`Failed: ${e.message}`,`error`)}finally{P(t,!1,`🗑️ Permanently Wipe All Data`)}})}async function Ot(e){let t=H();if(!t)return;U(e,`results`,`
  ...
  `,e.querySelector(`#btnPrintOfficial`).addEventListener(`click`,()=>{let e=`
    ...
    `),t.document.close()});let _=e.querySelector(`#btnAdminRefreshResults`);_&&c&&(_.onclick=async()=>{_.disabled=!0,_.innerHTML=`<span>⏳</span> Refreshing...`;try{await c(!0),F(`Election results refreshed with latest counts.`,`success`)}catch(e){F(`Refresh failed: ${e.message}`,`error`),_.disabled=!1,_.innerHTML=`<span>🔄</span> Refresh Results`}});let v=e.querySelector(`#btnToggleCounting`);v&&(v.onclick=async()=>{if(confirm(m?`Set Counting Mode Inactive? Visitors to the public portal will be asked to wait for counting to begin.`:`Set Counting Mode Active? Visitors to the public portal will see "Counting in Progress".`)){v.disabled=!0,v.textContent=`Please wait...`;try{m=(await C.adminToggleCounting(t)).active,o.countingActive=m?`true`:`false`,F(m?`⚡ Counting mode active! Public sees "Counting in Progress".`:`⏳ Counting mode inactive. Public asked to wait.`,`success`),kt(e,t,n,r,i,a,o,s,c)}catch(e){F(e.message,`error`),v.disabled=!1,v.textContent=m?`⏸️ Stop Counting`:`⚡ Set Counting Active`}}});let y=e.querySelector(`#btnToggleLock`);y&&(y.onclick=async()=>{if(confirm(f?`Unlock election results? Vote entries will be re-enabled.`:`Lock and freeze election results? No further vote entries will be allowed.`)){y.disabled=!0,y.textContent=`Please wait...`;try{f=(await C.adminToggleLockResults(t)).locked,o.resultsLocked=f?`true`:`false`,F(f?`🔒 Results locked and frozen.`:`🔓 Results unlocked for editing.`,`success`),kt(e,t,n,r,i,a,o,s,c)}catch(e){F(e.message,`error`),y.disabled=!1,y.textContent=f?`🔓 Unlock Results`:`🔒 Freeze / Lock`}}});let b=e.querySelector(`#btnTogglePublic`);b&&(b.onclick=async()=>{if(confirm(p?`Hide election results from public view? The public portal will show counting in progress.`:`Publish election results to the public portal? Anyone visiting the site will see live results.`)){b.disabled=!0,b.textContent=`Please wait...`;try{p=(await C.adminTogglePublishResults(t)).published,o.resultsPublished=p?`true`:`false`,F(p?`📢 Results published to public portal!`:`👁️‍🗨️ Results hidden from public view.`,`success`),kt(e,t,n,r,i,a,o,s,c)}catch(e){F(e.message,`error`),b.disabled=!1,b.textContent=p?`👁️‍🗨️ Hide Public View`:`📢 Publish to Public`}}})}var At=`election_results_cache`,jt=`election_results_last_fetch`,Mt=300*1e3;async function Nt(e){e.innerHTML=`
    <div class="page-enter min-h-screen">
      <header class="no-print sticky top-0 z-10 border-b border-white/10 glass">
        <div class="max-w-5xl mx-auto px-6 py-3 flex items-center justify-between">
          <div class="flex items-center gap-4">
  ...
  `;let t=e.querySelector(`#cacheTimer`),n=e.querySelector(`#btnRefresh`),r=()=>{let e=localStorage.getItem(jt);if(!e){t.textContent=``,n.disabled=!1,n.classList.remove(`opacity-50`,`cursor-not-allowed`);return}let r=parseInt(e,10)+Mt,i=Math.max(0,r-Date.now());i<=0?(t.textContent=`Live Update Available`,t.classList.add(`text-green-400`),n.disabled=!1,n.classList.remove(`opacity-50`,`cursor-not-allowed`,`pointer-events-none`)):(t.textContent=`Update in ${Math.floor(i/6e4)}:${Math.floor(i%6e4/1e3).toString().padStart(2,`0`)}`,t.classList.remove(`text-green-400`),n.disabled=!0,n.classList.add(`opacity-50`,`cursor-not-allowed`,`pointer-events-none`))};setInterval(r,1e3),r(),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`)),n.addEventListener(`click`,t=>{if(n.disabled||n.classList.contains(`pointer-events-none`)){t.preventDefault();return}Pt(e.querySelector(`#resultsMain`),!0)}),await Pt(e.querySelector(`#resultsMain`))}async function Pt(e,t=!1){try{let n=localStorage.getItem(jt),r=localStorage.getItem(At),i,a,s=!1,c=!1,l=!1;if(!t&&n&&r&&Date.now()-parseInt(n,10)<Mt)try{let t=JSON.parse(r);i=t.posts,a=t.results;let n=t.schedule||{};s=t.isCountingActive||n.countingActive===`true`,c=t.isResultsPublished||n.resultsPublished===`true`,l=t.isResultsLocked||!1,u(e,n.electionYear||new Date().getFullYear())}catch{localStorage.removeItem(At),localStorage.removeItem(jt),i=null}if(!i){e.innerHTML=`
      ...
      `,t&&(C.invalidateCache(`getResults`),C.invalidateCache(`getPosts`),C.invalidateCache(`getPublicSchedule`),C.invalidateCache(`getSettings`));let n,r,o;[i,r,n,o]=await Promise.all([C.getPosts(),C.getResults(t).catch(()=>({results:[],published:!1,countingActive:!1})),C.getPublicSchedule().catch(()=>({})),C.getSettings().catch(()=>({}))]),a=Array.isArray(r)?r:r?.results||[],s=r&&r.countingActive===!0||n?.countingActive===`true`||o?.countingActive===`true`,c=r&&r.published===!0||n?.resultsPublished===`true`||o?.resultsPublished===`true`,l=r&&r.locked===!0||o?.resultsLocked===`true`,localStorage.setItem(jt,Date.now().toString()),localStorage.setItem(At,JSON.stringify({posts:i,results:a,schedule:n,isCountingActive:s,isResultsPublished:c,isResultsLocked:l})),u(e,n?.electionYear||o?.electionYear||new Date().getFullYear())}function u(e,t){let n=e.closest(`.page-enter`)?.querySelector(`h1`);n&&(n.textContent=`Live Election Results ${t}`)}if(a.length===0||!c){s?(e.innerHTML=`
        ...
        `,e.querySelector(`#btnCountingRefresh`)?.addEventListener(`click`,()=>Pt(e,!0))):(e.innerHTML=`
      ...
      `:e.innerHTML=p}catch(t){e.innerHTML=`<div class="alert alert-error">❌ Failed to load results: ${N(t.message)}</div>`}}async function Ft(e){e.innerHTML=`
  ...
  `;try{let[t,n]=await Promise.all([C.getNominalRoll().catch(()=>[]),C.getSettings().catch(()=>({}))]);It(e,t,n)}catch(t){e.innerHTML=`<div class="alert alert-error">❌ ${N(t.message)}</div>`}}function It(e,t,r){let i=r.nominalRollFinalized===`true`||r.isRollFinalized===`true`,a=!i&&r.draftRollPublished===`true`,o=i||a,s=r.collegeName||n.COLLEGE_NAME;if(!o){e.innerHTML=`
  ...
  `;let v=t=>{let n=e.querySelector(`#classFilter`),r=u(t);r.includes(p)||(p=``),n.innerHTML=`
    ...
    `,v.innerHTML=y};y();let b=e.querySelector(`#searchInput`);b.addEventListener(`input`,e=>{d=e.target.value.trim(),h=1,y()});let x=e.querySelector(`#deptFilter`);x.addEventListener(`change`,e=>{f=e.target.value,v(f),h=1,y()}),e.querySelector(`#classFilter`).addEventListener(`change`,e=>{p=e.target.value,h=1,y()});let S=e.querySelector(`#arrangeSelect`);S&&S.addEventListener(`change`,e=>{m=e.target.value,h=1,y()}),e.querySelector(`#btnClearFilters`).addEventListener(`click`,()=>{d=``,f=``,p=``,m=`dept-class`,h=1,b.value=``,x.value=``,S&&(S.value=`dept-class`),v(``),y(),F(`Filters reset.`,`info`)}),e.querySelector(`#paginationControls`).addEventListener(`click`,t=>{let n=t.target.closest(`.pg-btn`);if(!n||n.disabled)return;let r=Number(n.dataset.page);r&&r!==h&&(h=r,y(),e.querySelector(`#rollTableBody`).scrollIntoView({behavior:`smooth`,block:`nearest`}))})}async function Lt(e){let t=H();t&&(U(e,`nominal-roll`,`
    <div class="text-center py-16"><span class="spinner" style="width:2.5rem;height:2.5rem;border-width:4px;"></span><p class="text-slate-400 mt-4 text-sm">Loading nominal roll...</p></div>
  `),await Q(e.querySelector(`#adminMain`),t))}async function Q(e,t){if(e){e.innerHTML=`
    <div class="text-center py-16"><span class="spinner" style="width:2.5rem;height:2.5rem;border-width:4px;"></span><p class="text-slate-400 mt-4 text-sm">Loading nominal roll...</p></div>
  `;try{let[n,r,i]=await Promise.all([C.getNominalRoll().catch(()=>[]),C.adminGetSettings(t),C.adminGetRollCorrections(t).catch(()=>[])]);Rt(e,t,n,r,i)}catch(t){e.innerHTML=`<div class="alert alert-error">❌ ${N(t.message)}</div>`}}}function Rt(e,t,n,r,i=[]){let a=r.nominalRollFinalized===`true`||r.isRollFinalized===`true`,o=!a&&r.draftRollPublished===`true`,s=!a&&!o,c=[...n];c.sort((e,t)=>I(e,t));let l=``,u=`dept-class`,d=1,f=`cards`,p=[...new Set(n.map(e=>L(e)).filter(Boolean))].sort((e,t)=>{let n=R(e),r=R(t);return n===r?e.localeCompare(t):n-r}),m=[...new Set(n.map(e=>String(e.Dept||``).trim()).filter(e=>e&&e!==`-`&&e!==`–`))].sort(),h=a?`
  ...
  `,g=()=>{let n=c.filter(e=>[e.NAME,e.CLASS,e[`ADMISION NO`]||e[`ADMISSION NO`],e[`Nominal Roll Serial Number`],e.Dept].some(e=>String(e||``).toLowerCase().includes(l.toLowerCase())));u===`dept-class`?n.sort((e,t)=>{let n=String(e.Dept||``).trim().toUpperCase(),r=String(t.Dept||``).trim().toUpperCase();if(n!==r)return n.localeCompare(r);let i=L(e).toUpperCase(),a=L(t).toUpperCase(),o=R(i),s=R(a);if(o!==s)return o-s;if(i!==a)return i.localeCompare(a);let c=String(e.NAME||``).trim().toUpperCase(),l=String(t.NAME||``).trim().toUpperCase();return c===l?I(e,t):c.localeCompare(l)}):u===`name`?n.sort((e,t)=>{let n=String(e.NAME||``).trim().toUpperCase(),r=String(t.NAME||``).trim().toUpperCase();return n===r?I(e,t):n.localeCompare(r)}):n.sort((e,t)=>I(e,t));let _=Math.max(1,Math.ceil(n.length/50));d>_&&(d=_),d<1&&(d=1);let v=(d-1)*50,y=Math.min(v+50,n.length),b=n.slice(v,y),x=``;if(_>1){x=`
        <button class="btn btn-sm btn-secondary px-2.5 py-1 text-xs pg-btn" data-page="1" ${d===1?`disabled style="opacity:0.35;cursor:not-allowed;"`:``} title="First Page">« First</button>
        <button class="btn btn-sm btn-secondary px-2.5 py-1 text-xs pg-btn" data-page="${d-1}" ${d===1?`disabled style="opacity:0.35;cursor:not-allowed;"`:``} title="Previous Page">‹ Prev</button>
      `;let e=[];for(let t=1;t<=_;t++)(t===1||t===_||t>=d-2&&t<=d+2)&&e.push(t);let t=0;e.forEach(e=>{t&&e-t>1&&(x+=`<span class="px-1 text-slate-500 font-bold">…</span>`),x+=`
          <button class="btn btn-sm px-3 py-1 text-xs font-mono rounded-lg pg-btn transition-colors ${e===d?`bg-indigo-600 text-white font-bold shadow-md shadow-indigo-900/40`:`btn-secondary text-slate-300 hover:text-white`}" data-page="${e}">
            ${e}
          </button>
        `,t=e}),x+=`
        <button class="btn btn-sm btn-secondary px-2.5 py-1 text-xs pg-btn" data-page="${d+1}" ${d===_?`disabled style="opacity:0.35;cursor:not-allowed;"`:``} title="Next Page">Next ›</button>
        <button class="btn btn-sm btn-secondary px-2.5 py-1 text-xs pg-btn" data-page="${_}" ${d===_?`disabled style="opacity:0.35;cursor:not-allowed;"`:``} title="Last Page">Last »</button>
      `}e.innerHTML=`
      <div class="page-enter space-y-6">
        ${h}
        ...
        <div class="glass rounded-xl p-4 flex flex-col md:flex-row gap-3 items-center w-full shadow-lg mb-2">
          <div class="relative flex-1 w-full">
            <span class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500">🔍</span>
            <input type="text" id="searchInput" class="field w-full pl-10 bg-black/20 focus:bg-black/40 transition-colors text-sm" placeholder="Search by student name, class, admission no, or serial..." value="${N(l)}">
          </div>
          <div class="w-full md:w-60 shrink-0">
            <select id="adminArrangeSelect" class="field text-xs bg-slate-900 border-white/10 text-white w-full py-2">
              <option value="dept-class" ${u===`dept-class`?`selected`:``}>🏢 Arrange: Dept ➔ Class ➔ Name (A-Z)</option>
              <option value="serial" ${u===`serial`?`selected`:``}>🔢 Arrange: Serial Number</option>
              <option value="name" ${u===`name`?`selected`:``}>🔤 Arrange: Student Name (A–Z)</option>
            </select>
          </div>
          <div class="flex items-center rounded-lg bg-black/40 p-1 border border-white/10 shrink-0 self-end md:self-center">
            <button type="button" id="btnModeCards" class="btn btn-xs py-1.5 px-3 rounded text-xs flex items-center gap-1.5 transition-all ${f===`cards`?`bg-indigo-600 text-white font-bold shadow-md shadow-indigo-900/40`:`text-slate-400 hover:text-white`}" title="Card View (Optimized for Mobile/Phone)">
              <span>📇</span> <span>Cards</span>
            </button>
            <button type="button" id="btnModeTable" class="btn btn-xs py-1.5 px-3 rounded text-xs flex items-center gap-1.5 transition-all ${f===`table`?`bg-indigo-600 text-white font-bold shadow-md shadow-indigo-900/40`:`text-slate-400 hover:text-white`}" title="Table View">
              <span>📑</span> <span>Table</span>
            </button>
          </div>
          <div class="text-slate-400 text-xs md:w-auto w-full text-right shrink-0">
            Showing <strong class="text-white">${n.length?v+1:0}</strong> to <strong class="text-white">${y}</strong> of <strong class="text-white">${n.length}</strong> students
          </div>
        </div>
        ...
        <div class="glass rounded-xl overflow-hidden shadow-2xl" id="adminRollListView">
          ...
          <div id="adminPaginationBar" class="p-4 border-t border-white/10 bg-black/20 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400">
            <div id="adminPaginationInfo">Page <strong class="text-white">${d}</strong> of <strong class="text-white">${_}</strong> (${n.length} total students)</div>
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <select id="addClass" class="field">
                ...
                ${p.map(e=>`<option value="${N(e)}">${N(e)}</option>`).join(``)}
              </select>
            </div>
            <div>
            ...
            <div>
              ...
              <select id="addDept" class="field">
                ...
                ${m.map(e=>`<option value="${N(e)}">${N(e)}</option>`).join(``)}
              </select>
            </div>
          </div>
...
This will lock the list and prevent any further additions, edits, or deletions.`))return;let r=async(i=!1)=>{P(n.target,!0,`Finalizing...`);try{let a=await C.adminFinalizeRoll(t,{matchNominations:i});if(a&&a.requiresMatching)return P(n.target,!1,`🔒 Finalize & Lock Roll`),confirm(`⚠️ ${a.count} existing nominations found!\n\nBecause you edited the Nominal Roll, their Serial Numbers have shifted.\n\nWould you like the system to automatically remap them using their Admission Numbers?`)?await r(!0):void 0;F(`Nominal Roll Finalized & Locked Successfully!`,`success`),await Q(e,t)}catch(e){F(e.message,`error`),P(n.target,!1,`🔒 Finalize & Lock Roll`)}};await r(!1)};e.querySelector(`#btnFinalize`)&&(e.querySelector(`#btnFinalize`).onclick=A),e.querySelector(`#btnFinalizeTop`)&&(e.querySelector(`#btnFinalizeTop`).onclick=A);let j=()=>{let t=e.querySelector(`#unfinalizeModal`),n=e.querySelector(`#unfinalizePwdInput`),r=e.querySelector(`#unfinalizeError`);n&&(n.value=``),r&&(r.textContent=``,r.classList.add(`hidden`)),t&&(t.classList.remove(`hidden`),n&&setTimeout(()=>n.focus(),50))};e.querySelector(`#btnUnfinalize`)&&(e.querySelector(`#btnUnfinalize`).onclick=j),e.querySelector(`#btnUnfinalizeBanner`)&&(e.querySelector(`#btnUnfinalizeBanner`).onclick=j),e.querySelector(`#btnCancelUnfinalize`)&&(e.querySelector(`#btnCancelUnfinalize`).onclick=()=>{e.querySelector(`#unfinalizeModal`)?.classList.add(`hidden`)});let M=async()=>{let n=e.querySelector(`#unfinalizePwdInput`),r=(n?.value||``).trim(),i=e.querySelector(`#unfinalizeError`),a=e.querySelector(`#btnConfirmUnfinalize`);if(!r){i&&(i.textContent=`❌ Please enter your admin password.`,i.classList.remove(`hidden`)),n?.focus();return}P(a,!0,`Unlocking...`),i&&i.classList.add(`hidden`);try{await C.adminUnfinalizeRoll(r),F(`Nominal Roll Unlocked! You can now add, edit, or delete students.`,`success`),e.querySelector(`#unfinalizeModal`)?.classList.add(`hidden`),await Q(e,t)}catch(e){let t=e.message&&(e.message.includes(`UNAUTHORIZED`)||e.message.includes(`password`))?`Incorrect admin password. Please try again.`:e.message||`Incorrect password`;i&&(i.textContent=`❌ ${t}`,i.classList.remove(`hidden`)),F(t,`error`),P(a,!1,`Confirm & Unlock`),n?.focus()}};e.querySelector(`#btnConfirmUnfinalize`)&&(e.querySelector(`#btnConfirmUnfinalize`).onclick=M),e.querySelector(`#unfinalizePwdInput`)&&(e.querySelector(`#unfinalizePwdInput`).onkeydown=e=>{e.key===`Enter`&&M()}),e.querySelector(`#btnPrintRoll`)&&(e.querySelector(`#btnPrintRoll`).onclick=()=>{ot({students:c,isFinal:a,isDraft:o,collegeName:r.collegeName,collegeLogo:r.collegeLogo,electionYear:r.electionYear,initialSort:u===`dept-class`?`dept-class`:u===`name`?`class`:`serial`})})};g()}async function zt(e){let t=H();t&&(U(e,`schedule`,`
  ...
  `),await Se(e.querySelector(`#nominationWrapper`)))}async function Ut(e){let t=H();if(!t)return;U(e,`audit`,`
    <div class="page-enter space-y-8">
      <div class="flex items-end justify-between">
        <div>
  ...
  `);let n=e.querySelector(`#btnRunAudit`),r=e.querySelector(`#auditResults`);n.addEventListener(`click`,async()=>{n.disabled=!0,n.innerHTML=`<span class="spinner w-4 h-4 mr-2 border-2"></span> Running Audit...`,r.innerHTML=`
    ...
    `;try{let e=(await C.adminRunAudit(t)).report,n=(e,t)=>t.pass?`
      ...
      `,e.rollCheck.pass&&e.serialCheck.pass&&e.resultsCheck.pass&&e.formsCheck.pass?r.innerHTML=`
         ...
         `+r.innerHTML,F(`Audit completed.`,`info`)}catch(e){r.innerHTML=`<div class="alert alert-error">❌ Audit failed: ${N(e.message)}</div>`,F(e.message,`error`)}finally{n.disabled=!1,n.innerHTML=`<span class="mr-2">🔍</span> Run Full System Audit`}})}async function Wt(e){let t=H();if(t){U(e,`settings`,`
...
5. In the event of an equality of votes between two candidates, the result shall be decided by the Returning Officer drawing lots in the presence of the candidates.`}]}async function Yt(e){let t=H();t&&(U(e,`notices`,`
    <div class="text-center py-16">
      <span class="spinner" style="width:2.5rem;height:2.5rem;border-width:4px;"></span>
...
`);var en=document.getElementById(`sync-status`),tn=document.getElementById(`sync-icon`),nn=document.getElementById(`sync-text`);m(e=>{e===`saving`?(en.classList.remove(`translate-y-[-150%]`,`opacity-0`),en.classList.add(`translate-y-0`,`opacity-100`),tn.className=`animate-spin inline-block text-indigo-400`,tn.innerHTML=`&#8635;`,nn.innerText=`Saving changes...`):e===`saved`?(tn.className=`inline-block text-emerald-400`,tn.innerHTML=`&#10003;`,nn.innerText=`All changes saved`):e===`idle`&&(en.classList.remove(`translate-y-0`,`opacity-100`),en.classList.add(`translate-y-[-150%]`,`opacity-0`))}),C.initPublicData();