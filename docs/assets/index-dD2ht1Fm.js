...
`)}function re(e,t={}){let r=t.collegeName||n.COLLEGE_NAME;t.collegeShortName||n.COLLEGE_SHORT_NAME;let i=t.electionYear||new Date().getFullYear(),a=t.collegeLogo||``,o=window.open(``,`_blank`);if(!o){alert(`Pop-up blocker prevented opening the print window. Please allow pop-ups for this site.`);return}let s=ne(e.content||``);o.document.write(`<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <title>${F(e.refNo||`Notice`)} - ${F(e.title)}</title>
  <style>
    @page { size: A4; margin: 15mm; }
    * { box-sizing: border-box; }
    body {
  ...
  <div class="page-container">
    <table class="header-table">
      <tr>
        ...
        <td style="vertical-align: middle; text-align: center;">
          <h1 class="college-name">${F(r)}</h1>
          <div class="sub-header">Office of the Returning Officer — College Union Elections ${F(i)}</div>
        </td>
      </tr>
    </table>

    <div class="meta-bar">
      <div><strong>Ref No:</strong> ${F(e.refNo||`N/A`)}</div>
      <div><strong>Date of Issue:</strong> ${F(e.date||new Date().toISOString().split(`T`)[0])}</div>
    </div>

    <div class="notice-title-box">
      <h2 class="notice-title">${F(e.title)}</h2>
      <div class="category-tag">Official Publication • ${F(e.category||`General Notice`)}</div>
    </div>
    ...
    <div class="signature-area">
      ...
      <div class="signatory-box">
        ...
        <p class="signatory-name">${F(e.signatoryName||`Returning Officer`)}</p>
        <p class="signatory-title">${F(e.signatoryTitle||`Returning Officer, ${r}`)}</p>
      </div>
    </div>
      ...
      <div class="poster-page ${n<e.length-1?`page-break`:``}">
        ...
        <div class="poster-border">
          ...
          <div class="poster-header">
            ...
            <div>
              <div class="college-title">${F(i)}</div>
              <div class="election-title">College Union Elections ${F(o)} — Official Polling Station</div>
            </div>
          </div>
          ...
          <div class="booth-giant-banner">
            ...
            <div class="booth-main-number">BOOTH NO. ${F(t.boothNumber)}</div>
          </div>
          ...
          <div class="location-banner">
            ...
            <span class="location-name">${F(t.roomName||`Classroom / Designated Hall`)}</span>
          </div>
            ...
            <div class="classes-grid">
              ${r.length?r.map(e=>`
                <div class="class-card">
                  ...
                  <span class="class-text">${F(e)}</span>
                </div>
              `).join(``):`
          ...
          <div class="rules-box">
            ...
            <div class="rule-item">
              <span class="rule-icon">⏰</span>
              <span><strong>POLLING HOURS:</strong> ${F(u)} to ${F(d)} strictly</span>
            </div>
            <div class="rule-item">
              <span class="rule-icon">🚫</span>
...
<head>
  <meta charset="utf-8">
  <title>Polling Booth Door Posters - ${F(a)} Election ${F(o)}</title>
  <style>
    @page {
      size: A4 portrait;
      margin: 8mm;
...
<head>
  <meta charset="utf-8">
  <title>Campus Master Polling Directory - ${F(a)} Election ${F(o)}</title>
  <style>
    @page {
      size: A4 portrait;
      margin: 10mm;
  ...
  <div class="master-container">
    <div>
      <div class="master-header">
        ...
        <div>
          <h1 class="college-name">${F(i)}</h1>
          <div class="election-title">College Union Elections ${F(o)} — Office of the Returning Officer</div>
        </div>
      </div>
      ...
      <div class="info-bar">
        <div>📅 <strong>Polling Date:</strong> ${F(u)}</div>
        <div>⏰ <strong>Polling Hours:</strong> ${F(d)} to ${F(f)}</div>
    ...
    <div>
      ...
      <div class="master-footer">
        ...
        <div class="footer-sign">
          ...
          <div style="font-size: 10px; color: #444;">${F(i)}</div>
        </div>
      </div>
    </div>
  </div>
...
</html>`),c.document.close()}function se(e={}){let t=e.collegeName||n.COLLEGE_NAME,r=e.collegeShortName||n.COLLEGE_SHORT_NAME,i=e.electionYear||new Date().getFullYear(),a=e.collegeLogo||``,o=window.open(``,`_blank`);if(!o){alert(`Pop-up blocker prevented opening the print window. Please allow pop-ups for this site.`);return}o.document.write(`<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <title>Blank Nomination Paper - ${F(r)} Election ${F(i)}</title>
  <style>
    @page {
      size: A4 portrait;
  ...
  <div class="form-container">
    <div class="header-box">
      ...
      <div style="flex:1;text-align:center;">
        <div class="college-name">${F(t)}</div>
        <div class="college-sub">(Affiliated to the University of Calicut)</div>
        <div class="election-title">COLLEGE UNION ELECTIONS ${F(i)}–${Number(i)+1}</div>
      </div>
    ...
    <table class="sign-table">
      <tr>
        <td style="width:35%;">
          ...
          <div style="font-size:8pt;color:#555;">Place: ${F(r)} Campus</div>
        </td>
        <td style="width:30%;">
    ...
    <div class="receipt-slip">
      ...
      <div class="receipt-header">OFFICIAL RECEIPT &mdash; NOMINATION PAPER (${F(r)} ELECTIONS ${F(i)})</div>
...
</html>`),o.document.close()}function ce(e={}){let t=e.collegeName||n.COLLEGE_NAME,r=e.collegeShortName||n.COLLEGE_SHORT_NAME,i=e.electionYear||new Date().getFullYear(),a=e.collegeLogo||``,o=window.open(``,`_blank`);if(!o){alert(`Pop-up blocker prevented opening the print window. Please allow pop-ups for this site.`);return}o.document.write(`<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <title>Blank Withdrawal Form - ${F(r)} Election ${F(i)}</title>
  <style>
    @page {
      size: A4 portrait;
      margin: 12mm 16mm;
...
<body>
  <div class="form-container">
    ...
    <div class="recipient-box">
      ...
      College Union Elections ${F(i)}–${Number(i)+1},<br>
      ${F(t)}.
    </div>
    ...
    <div class="decl-box">
      I, <span class="line-fill" style="width:45%;"></span>, a validly nominated candidate for the post of <span class="line-fill" style="width:40%;"></span> in the College Union Elections for the academic year ${F(i)}–${Number(i)+1}, do hereby give notice that I voluntarily <strong>WITHDRAW</strong> my candidature for the said post.
      <br><br>
...
</html>`),o.document.close()}var z=[],le=[],ue=[],B={},de=``;async function fe(e){let t=new Date().getFullYear(),r=n.COLLEGE_NAME,i=n.COLLEGE_SHORT_NAME;try{let[e,n]=await Promise.all([C.getPublicSchedule().catch(()=>({})),C.getSettings().catch(()=>({}))]);e.electionYear&&(t=e.electionYear),n.electionYear&&(t=n.electionYear),n.collegeName&&(r=n.collegeName),n.collegeShortName&&(i=n.collegeShortName)}catch{}e.innerHTML=Se(`Submit Nomination`,`
  ...
  `,t,i),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`));try{let[i,a,o,s,c]=await Promise.all([C.getNominalRoll(),C.getPosts().catch(()=>null),C.getPublicNominations().catch(()=>[]),C.getPublicSchedule().catch(()=>({})),C.getSettings().catch(()=>({}))]);if(z=Array.isArray(i)?i:[],ue=Array.isArray(o)?o:[],B=s||{},z.length===0)throw Error(`Nominal roll is empty. Please contact the admin.`);le=Array.isArray(a)&&a.length>0?a:n.DEFAULT_POSTS,pe(e,t,r,c||{})}catch(t){e.querySelector(`#loadingState`).innerHTML=`
      <div class="alert alert-error">${F(t.message)}</div>
      <button class="btn btn-secondary mt-4" id="backBtn">← Back to Home</button>`,e.querySelector(`#backBtn`).addEventListener(`click`,()=>o.navigate(`/`))}}function pe(e,t,n,r={}){let i=A();de=i.answer,e.querySelector(`#loadingState`).classList.add(`hidden`);let a=e.querySelector(`#formArea`);a.classList.remove(`hidden`);let s=r.nominalRollFinalized===`true`||r.isRollFinalized===`true`,c=!s&&r.draftRollPublished===`true`;if(!window.ADMIN_BYPASS_PWD&&!s){a.innerHTML=`
    ...
    `,a.querySelector(`#viewRollBtn`).onclick=()=>o.navigate(`/nominal-roll`),a.querySelector(`#backBtn`).onclick=()=>o.navigate(`/`),a.querySelectorAll(`.btn-blank-nom-trigger`).forEach(e=>e.onclick=()=>me(r));return}let l=B.nominationOverride||`AUTO`,u=l===`FORCE_OPEN`,d=l===`FORCE_CLOSED`,f=new Date,p=B.nominationStart?new Date(B.nominationStart):null,m=B.nominationDeadline?new Date(B.nominationDeadline):null;if(!window.ADMIN_BYPASS_PWD&&!u){if(d){a.innerHTML=`
      ...
      `,a.querySelector(`#expiredBackBtn`).onclick=()=>o.navigate(`/`),a.querySelectorAll(`.btn-blank-nom-trigger`).forEach(e=>e.onclick=()=>me(r));return}if(p&&!isNaN(p.getTime())&&f<p){a.innerHTML=`
        <div class="glass p-12 text-center rounded-2xl border border-amber-500/20 max-w-2xl mx-auto page-enter">
          <div class="text-6xl mb-6">📅</div>
          <div class="badge bg-amber-500/20 text-amber-300 border border-amber-500/40 px-3 py-1 text-xs font-bold uppercase tracking-widest mb-3 inline-block">
            Scheduled Opening
      ...
      `,a.querySelector(`#pendingBackBtn`).onclick=()=>o.navigate(`/`),a.querySelectorAll(`.btn-blank-nom-trigger`).forEach(e=>e.onclick=()=>me(r));return}if(m&&!isNaN(m.getTime())&&f>m){a.innerHTML=`
        <div class="glass p-12 text-center rounded-2xl border border-rose-500/20 max-w-2xl mx-auto page-enter">
          <div class="text-6xl mb-6">⏳</div>
          <div class="badge bg-rose-500/20 text-rose-300 border border-rose-500/40 px-3 py-1 text-xs font-bold uppercase tracking-widest mb-3 inline-block">
            Filing Ended
      ...
      `,a.querySelector(`#expiredBackBtn`).onclick=()=>o.navigate(`/`),a.querySelectorAll(`.btn-blank-nom-trigger`).forEach(e=>e.onclick=()=>me(r));return}}a.innerHTML=`
    ...
    <form id="nomForm" class="space-y-8">
      ...
      <div>
        ...
        <select id="postSelect" class="field">${le.map(e=>`<option value="${F(e.post)}">${F(e.post)}</option>`).join(``)}</select>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ${ge(`candidate`,`Candidate`,!0)}
        ${ge(`proposer`,`Proposer`,!1)}
        ${ge(`seconder`,`Seconder`,!1)}
      </div>
...
Do you want to proceed and print the blank form?`)&&se(e)}function he(e,t,n){let r=document.getElementById(`findSerialModalContainer`);r&&r.remove();let i=document.createElement(`div`);i.id=`findSerialModalContainer`,i.className=`fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm page-enter`,i.innerHTML=`
  ...
  `,document.body.appendChild(i);let a=i.querySelector(`#serialSearchInput`),o=i.querySelector(`#serialSearchResults`),s=i.querySelector(`#closeSerialModalBtn`),c=()=>i.remove();s.onclick=c,i.onclick=e=>{e.target===i&&c()},a.oninput=()=>{let t=a.value.trim().toLowerCase();if(!t){o.innerHTML=`<p class="text-slate-500 text-xs text-center py-6">Type a student name or admission number to search ${z.length} students.</p>`;return}let r=z.filter(e=>{let n=String(e.NAME||e.name||``).toLowerCase(),r=String(e[`ADMISION NO`]||e[`ADMISSION NO`]||e.admission_no||e[`Admission No`]||e[`Adm No`]||``).toLowerCase(),i=String(e.CLASS||e.class||``).toLowerCase(),a=String(e.Dept||e.dept||``).toLowerCase(),o=String(e[`Nominal Roll Serial Number`]||e.serial_number||``);return n.includes(t)||r.includes(t)||i.includes(t)||a.includes(t)||o===t||o.includes(t)}).slice(0,30);if(r.length===0){o.innerHTML=`<p class="text-rose-400 text-xs text-center py-6">No matching student found in the published Nominal Roll for "${F(t)}".</p>`;return}o.innerHTML=r.map(t=>{let n=String(t[`Nominal Roll Serial Number`]||t.serial_number||``),r=String(t.NAME||t.name||``),i=String(t[`ADMISION NO`]||t[`ADMISSION NO`]||t.admission_no||t[`Admission No`]||t[`Adm No`]||`–`),a=String(t.CLASS||t.class||``),o=String(t.Dept||t.dept||`N/A`),s=a.toUpperCase().includes(`RESEARCH`)||a.toUpperCase().includes(`SCHOLAR`),c=e===`candidate`&&s;return`
      ...
      `}).join(``),o.querySelectorAll(`.select-serial-btn`).forEach(e=>{e.onclick=()=>{n(e.dataset.serial,e.dataset.adm),c()}})},setTimeout(()=>a.focus(),100)}function ge(e,t,n){return`
  <div class="glass rounded-xl p-4 space-y-3 border border-white/10 shadow-lg">
  ...
  </div>`}function _e(e,t){let n=e.querySelector(`#serial-${t}`)?.value.trim(),r=e.querySelector(`#details-${t}`);if(!r)return;let i=z.find(e=>String(e[`Nominal Roll Serial Number`]||e.serial_number||``)===n);if(!i){r.innerHTML=n?`
    ...
    </div>`,V(e)}function V(e){let t=[],n=e.querySelector(`#postSelect`)?.value,r=e.querySelector(`[name="gender"]:checked`)?.value||null,i=[`candidate`,`proposer`,`seconder`].map(t=>e.querySelector(`#serial-${t}`)?.value.trim()||``),a=i.map(e=>e?z.find(t=>String(t[`Nominal Roll Serial Number`]||t.serial_number||``)===e):null),[o,s,c]=i;o&&o===s&&t.push(`Candidate and Proposer cannot be the same person.`),o&&o===c&&t.push(`Candidate and Seconder cannot be the same person.`),s&&s===c&&t.push(`Proposer and Seconder cannot be the same person.`);let l=e.querySelector(`#auth-candidate`),u=l?.value.trim().toLowerCase(),d=a[0],f=e.querySelector(`#auth-feedback`);if(d&&u){let e=String(d[`ADMISION NO`]||d[`ADMISSION NO`]||d.admission_no||``).trim().toLowerCase();e&&u!==e?(t.push(`Authentication Failed: Entered Admission Number "${l.value}" does NOT match Electoral Roll Serial #${d[`Nominal Roll Serial Number`]} (${d.NAME}). A mismatched serial number will result in rejection!`),f&&(f.innerHTML=`<span class="text-rose-400 text-xs font-semibold flex items-center gap-1 mt-1">❌ Mismatch with Serial #${F(d[`Nominal Roll Serial Number`])}! Registered Adm No is different.</span>`)):e&&u===e&&f&&(f.innerHTML=`<span class="text-emerald-400 text-xs font-semibold flex items-center gap-1 mt-1">✅ Verified: Admission No matches Electoral Roll Serial #${F(d[`Nominal Roll Serial Number`])}</span>`)}else f&&(f.innerHTML=``);let p=[`Candidate`,`Proposer`,`Seconder`];a.forEach((e,i)=>{e&&t.push(...k(e,n,p[i],i===0?r:null,le,ue))});let m=e.querySelector(`#warningBox`);return m&&(t.length?(m.innerHTML=`<strong class="block mb-1">⚠ Eligibility & Serial Number Warnings</strong>`+t.map(e=>`<p class="text-sm">• ${F(e)}</p>`).join(``),m.classList.remove(`hidden`)):m.classList.add(`hidden`)),t}async function ve(e,t,n,r,i=``){if(e.preventDefault(),V(t).length){L(`Please resolve all eligibility warnings first.`,`error`);return}if(t.querySelector(`#captchaInput`)?.value.trim()!==de){L(`Captcha answer is incorrect.`,`error`);return}let a=t.querySelector(`#postSelect`)?.value,o=t.querySelector(`[name="gender"]:checked`)?.value,s=t.querySelector(`#dob-day`)?.value,c=t.querySelector(`#dob-month`)?.value,l=t.querySelector(`#dob-year`)?.value;if(!o){L(`Please select a gender for the candidate.`,`error`);return}if(!s||!c||!l){L(`Please select a complete Date of Birth (Day, Month, Year).`,`error`);return}let u=[`candidate`,`proposer`,`seconder`].map(e=>t.querySelector(`#serial-${e}`)?.value.trim()||``),d=u.map(e=>z.find(t=>String(t[`Nominal Roll Serial Number`]||t.serial_number||``)===e));if(d.some(e=>!e)){L(`One or more serial numbers are invalid.`,`error`);return}let f=t.querySelector(`#auth-candidate`)?.value.trim();if(!f){L(`Please enter the Candidate Admission Number.`,`error`);return}let p=t.querySelector(`#submitBtn`);I(p,!0,`Generating & Previewing...`);try{let e=N(s,c,l),p={post:a,gender:o,dob:e,candidateSerial:u[0],proposerSerial:u[1],seconderSerial:u[2],candidateAdmission:f};window.ADMIN_BYPASS_PWD&&(p.password=window.ADMIN_BYPASS_PWD);let m=await C.submitNomination(p);ye(t,m.id,{post:a,gender:o,day:s,month:c,year:l,dob:e,students:d},n,r,i),L(`Nomination submitted! ID: ${m.id}`,`success`)}catch(e){L(`Submission failed: ${e.message}`,`error`)}finally{I(p,!1,`Generate &amp; Preview Nomination`)}}function ye(e,t,{post:n,gender:r,day:i,month:a,year:o,dob:s,students:c},l,u,d=``){let[f,p,m]=c,h=P(i,a,o),g=w(s),_=e.querySelector(`#previewSection`);e.querySelector(`#printZone`).innerHTML=be(t,n,r,h,g,f,p,m,`Pending`,l,u,d),_.classList.remove(`hidden`),_.scrollIntoView({behavior:`smooth`}),_.querySelector(`#printBtn`)?.addEventListener(`click`,()=>{ee(e.querySelector(`#printZone`).innerHTML)}),_.querySelector(`#newNomBtn`)?.addEventListener(`click`,()=>fe(e.closest(`#app`)))}function be(e,t,r,i,a,o,s,c,l=``,u=`2026`,d=null,f=``){let p=j(),m=d||n.COLLEGE_NAME;return`
  ...
  </div>`}function xe(e,t,n=null,r=null,i=null){if(!t)return``;let a=t[`Nominal Roll Serial Number`]||t.serial_number||t.SL_NO||``,o=t[`ADMISION NO`]||t[`ADMISSION NO`]||t.admission_no||t.candidateAdmission||t.proposerAdmission||t.seconderAdmission||``;return`
  ...
  </div>`}function Se(e,t,r=`2026`,i=null){let a=i||n.COLLEGE_SHORT_NAME;return`
  ...
  </div>`}async function Ce(e){let t=new Date().getFullYear(),r=n.COLLEGE_SHORT_NAME,i=n.COLLEGE_NAME,a=``;try{let e=await C.getSettings().catch(()=>({}));e.electionYear&&(t=e.electionYear),e.collegeName&&(i=e.collegeName),e.collegeShortName&&(r=e.collegeShortName),e.collegeLogo&&(a=e.collegeLogo)}catch{}e.innerHTML=Te(`Find My Nomination`,`
  ...
  <div class="page-enter min-h-screen">
    ...
    <main class="max-w-4xl mx-auto px-4 py-8">${t}</main>
  </div>`}async function Ee(e){let t=new Date().getFullYear(),r=n.COLLEGE_SHORT_NAME;try{let[e,n]=await Promise.all([C.getPublicSchedule().catch(()=>({})),C.getSettings().catch(()=>({}))]);e.electionYear&&(t=e.electionYear),n.electionYear&&(t=n.electionYear),n.collegeShortName&&(r=n.collegeShortName)}catch{}e.innerHTML=Oe(`Valid Nominations List`,`
  ...
  `,t,r),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`));try{let t=await C.getValidNominations();De(e.querySelector(`main`),t)}catch{De(e.querySelector(`main`),[])}}function De(e,t){if(!t||t.length===0){e.innerHTML=`
  ...
  </div>`}async function ke(e){let t=new Date().getFullYear(),r=n.COLLEGE_SHORT_NAME;try{let[e,n]=await Promise.all([C.getPublicSchedule().catch(()=>({})),C.getSettings().catch(()=>({}))]);e.electionYear&&(t=e.electionYear),n.electionYear&&(t=n.electionYear),n.collegeShortName?r=n.collegeShortName:n.shortName&&(r=n.shortName)}catch{}e.innerHTML=je(`Final Candidates List`,`
  ...
  `,t,r),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`));try{let n=await C.getFinalNominations();Ae(e.querySelector(`main`),n?.active||[],t)}catch{Ae(e.querySelector(`main`),[],t)}}function Ae(e,t,n){if(!t||t.length===0){e.innerHTML=`
      <div class="glass rounded-3xl p-20 text-center border-dashed border-white/10">
        <div class="text-6xl mb-6">🏁</div>
  ...
  <div class="page-enter min-h-screen">
    ...
    <main class="max-w-5xl mx-auto px-4 py-12">${t}</main>
  </div>`}async function Me(e){let t=new Date().getFullYear(),r=n.COLLEGE_SHORT_NAME,i=n.COLLEGE_NAME;try{let[e,n]=await Promise.all([C.getPublicSchedule().catch(()=>({})),C.getSettings().catch(()=>({}))]);e.electionYear&&(t=e.electionYear),n.electionYear&&(t=n.electionYear),n.collegeName&&(i=n.collegeName),n.collegeShortName&&(r=n.collegeShortName)}catch{}e.innerHTML=Fe(`Withdrawal Form`,`
    <div id="loadingState" class="flex flex-col items-center justify-center py-24 gap-4">
      <span class="spinner" style="width:2.5rem;height:2.5rem;border-width:4px;"></span>
  ...
  `,t,r),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`));try{let[t,n]=await Promise.all([C.getPublicSchedule().catch(()=>({})),C.getSettings().catch(()=>({}))]),r=new Date,a=t.withdrawalStart?new Date(t.withdrawalStart):null,s=t.withdrawalEnd?new Date(t.withdrawalEnd):null,c=n?.validListPublished===`true`||t?.validListPublished===`true`,l=e.querySelector(`#withdrawArea`);if(e.querySelector(`#loadingState`).classList.add(`hidden`),l.classList.remove(`hidden`),!c){l.innerHTML=`
      ...
      `,l.querySelector(`#expiredBackBtn`).onclick=()=>o.navigate(`/`),l.querySelectorAll(`.btn-blank-with-trigger`).forEach(e=>e.onclick=()=>H(n));return}let u=t.withdrawalOverride||`AUTO`,d=u===`FORCE_OPEN`,f=u===`FORCE_CLOSED`;if(!d){if(f){l.innerHTML=`
          <div class="glass p-12 text-center rounded-2xl border border-rose-500/20 max-w-2xl mx-auto page-enter">
            <div class="text-6xl mb-6">🛑</div>
        ...
        `,l.querySelector(`#expiredBackBtn`).onclick=()=>o.navigate(`/`),l.querySelectorAll(`.btn-blank-with-trigger`).forEach(e=>e.onclick=()=>H(n));return}if(a&&r<a){l.innerHTML=`
          <div class="glass p-12 text-center rounded-2xl border border-amber-500/20 max-w-2xl mx-auto page-enter">
            <div class="text-6xl mb-6">📅</div>
        ...
        `,l.querySelector(`#expiredBackBtn`).onclick=()=>o.navigate(`/`),l.querySelectorAll(`.btn-blank-with-trigger`).forEach(e=>e.onclick=()=>H(n));return}if(s&&r>s){l.innerHTML=`
          <div class="glass p-12 text-center rounded-2xl border border-rose-500/20 max-w-2xl mx-auto page-enter">
            <div class="text-6xl mb-6">⏳</div>
            <h3 class="text-2xl font-bold text-white mb-3">Withdrawal Window Closed</h3>
        ...
        `,l.querySelector(`#expiredBackBtn`).onclick=()=>o.navigate(`/`),l.querySelectorAll(`.btn-blank-with-trigger`).forEach(e=>e.onclick=()=>H(n));return}}l.innerHTML=`
    ...
    `,l.querySelectorAll(`.btn-blank-with-trigger`).forEach(e=>e.onclick=()=>H(n));let p=l.querySelector(`#fetchBtn`);p.addEventListener(`click`,async()=>{let e=l.querySelector(`#withdrawId`).value.trim(),t=l.querySelector(`#authAdm`).value.trim();if(e.length!==10||!/^\d+$/.test(e)){L(`Please enter a valid 10-digit numeric ID.`,`error`);return}if(!t){L(`Please enter your Admission Number.`,`error`);return}I(p,!0,`Fetch Nomination Details`);try{let n=await C.getNomination(e,t);Ne(l.querySelector(`#nominationDetails`),n,e,t,i)}catch(e){l.querySelector(`#nominationDetails`).innerHTML=`<div class="alert alert-error">❌ ${F(e.message)}</div>`}finally{I(p,!1,`Fetch Nomination Details`)}})}catch(t){e.querySelector(`#loadingState`).innerHTML=`<div class="alert alert-error">❌ ${F(t.message)}</div>`}}function Ne(e,t,n,r,i=null){if(t.status!==`Valid`){e.innerHTML=`<div class="alert alert-warning">⚠ This nomination has status <strong>${F(t.status)}</strong>. Only <strong>Valid</strong> nominations can be withdrawn.</div>`;return}if(t.withdrawalStatus===`Requested`||t.withdrawalStatus===`Pending`||t.withdrawalStatus===`Approved`){e.innerHTML=`<div class="alert alert-info">ℹ A withdrawal request has already been ${t.withdrawalStatus===`Approved`?`approved`:`submitted and is currently under review by the Returning Officer`} for this nomination.</div>`;return}e.innerHTML=`
    <div class="space-y-4">
      ...
      <div class="flex gap-3">
        ...
        <div class="print-zone mt-4">
          ${Pe(n,t,i)}
        </div>`,e.querySelector(`#printWithdrawal`).addEventListener(`click`,()=>{ee(e.querySelector(`.print-zone`).innerHTML,`Withdrawal Form`)}),L(`Withdrawal request submitted!`,`success`)}catch(e){L(`Failed: ${e.message}`,`error`),I(a,!1,`Submit Withdrawal Request`)}})}function H(e={}){confirm(`⚠️ NOTICE: BLANK WITHDRAWAL FORM
...
Do you want to proceed and print the blank form?`)&&ce(e)}function Pe(e,t,r=null){let i=j(),a=t.candidate?.NAME||t.candidateName||`N/A`,o=t.candidate?.CLASS||t.candidateClass||`N/A`,s=t.candidate?.Dept||t.candidateDept||`N/A`;return`
  ...
  </div>`}function Fe(e,t,r=`2026`,i=null){let a=i||n.COLLEGE_SHORT_NAME;return`
  <div class="page-enter min-h-screen">
    <header class="no-print sticky top-0 z-50 border-b border-white/10 glass">
      <div class="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
        <div class="flex items-center gap-4">
  ...
  </div>`,e.querySelectorAll(`[data-admin-nav]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.adminNav;if(t===`public`){o.navigate(`/`);return}o.navigate(`/admin/${t}`)})}),e.querySelector(`#logoutBtn`).addEventListener(`click`,async()=>{try{let e=localStorage.getItem(`adminPwd`);e&&await C.adminLogout(e)}catch(e){console.error(`Logout API failed:`,e)}localStorage.removeItem(`adminPwd`),localStorage.removeItem(`adminLoginDate`),localStorage.removeItem(`adminSessionToken`),sessionStorage.removeItem(`adminSessionToken`),L(`Logged out.`,`info`),o.navigate(`/`)})}function G(e,t,n,r){return`
  <button data-admin-nav="${e}" class="sidebar-item ${r===e?`active`:``}">
    <span>${t}</span> ${n}
  </button>`}async function Ve(e){let t=U();if(t){W(e,`dashboard`,`
  ...
  `);try{let[n,i]=await Promise.all([C.adminGetNominations(t,!0),C.adminGetSettings(t)]),a=n.length,o=n.filter(e=>e.status===`Pending`).length,s=n.filter(e=>e.status===`Valid`).length,c=n.filter(e=>e.status===`Rejected`).length,l=n.filter(e=>e.withdrawalStatus===`Requested`||e.withdrawalStatus===`Pending`).length,u=e.querySelector(`#adminMain`);u.innerHTML=`
      <div class="page-enter space-y-8">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
          ${He(`Total Submissions`,a,`from-indigo-500/20 to-indigo-600/5`,`text-indigo-400`)}
          ${He(`Pending Review`,o,`from-amber-500/20 to-amber-600/5`,`text-amber-400`)}
          ${He(`Valid Nominations`,s,`from-emerald-500/20 to-emerald-600/5`,`text-emerald-400`)}
          ${He(`Rejected`,c,`from-rose-500/20 to-rose-600/5`,`text-rose-400`)}
        </div>
      ...
      </div>`,e.querySelectorAll(`[data-admin-nav]`).forEach(e=>{e.addEventListener(`click`,()=>{ze(async()=>{let{router:e}=await Promise.resolve().then(()=>r);return{router:e}},void 0,import.meta.url).then(({router:t})=>t.navigate(`/admin/${e.dataset.adminNav}`))})})}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${F(t.message)}</div>`}}}function He(e,t,n,r){return`
  ...
  `;let l=[],u=null,d=e.querySelector(`#nomDetailModal`),f=e.querySelector(`#modalPaperZone`),p=e.querySelector(`#modalScrutinyZone`),m=e.querySelector(`#modalNomIdBadge`),h=e.querySelector(`#modalNomStatusBadge`),g=e.querySelector(`#modalNomTimestamp`),_=e.querySelector(`#modalNomCounter`),v=e.querySelector(`#btnModalPrevNom`),y=e.querySelector(`#btnModalNextNom`),b=e.querySelector(`#btnModalMarkValid`),x=e.querySelector(`#btnModalMarkReject`),S=e.querySelector(`#modalRejectionBanner`),T=e.querySelector(`#modalRejectionText`),E=t=>{let n=e.querySelector(`#nomTableBody`),r=e.querySelector(`#nomCardsContainer`);n.innerHTML=t.length?t.map(e=>{let t=K(e,s,o,i),n=String(e.candidateClass||``).toUpperCase().includes(`RESEARCH`)||String(e.candidateClass||``).toUpperCase().includes(`SCHOLAR`);return`
      ...
      </tr>`}).join(``):`<tr><td colspan="8" class="text-center text-slate-500 py-12">No nominations found matching those criteria.</td></tr>`,r&&(r.innerHTML=t.length?t.map(e=>{let t=K(e,s,o,i),n=String(e.candidateClass||``).toUpperCase().includes(`RESEARCH`)||String(e.candidateClass||``).toUpperCase().includes(`SCHOLAR`);return`
  ...
  `);try{let n=await C.adminGetNominations(t,!0);Ke(e.querySelector(`#adminMain`),n,t)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${F(t.message)}</div>`}}}function Ke(e,t,n){let r=Array.isArray(t)?t:[],i=r.filter(e=>e.withdrawalStatus&&e.withdrawalStatus!==`None`),a=r.filter(e=>e.status===`Valid`&&e.withdrawalStatus!==`Approved`),o=r.filter(e=>e.withdrawalStatus===`Approved`);e.innerHTML=`
    <div class="page-enter space-y-4">
      <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-2">
        <div>
    ...
    `,b.querySelector(`#btnClosePrintModal`).onclick=()=>b.remove(),b.querySelector(`#btnCancelPrintModal`).onclick=()=>b.remove(),b.querySelector(`#printModalBackdrop`).onclick=()=>b.remove(),b.querySelectorAll(`.scope-btn`).forEach(e=>{e.onclick=()=>{m=e.dataset.scope,x()}});let c=b.querySelector(`#printDeptSelect`);c&&(c.onchange=e=>{h=e.target.value,x()});let l=b.querySelector(`#printClassDeptFilter`);l&&(l.onchange=e=>{h=e.target.value,x()});let u=b.querySelector(`#printClassSelect`);u&&(u.onchange=e=>{g=e.target.value,x()});let S=b.querySelector(`#printSortSelect`);S&&(S.onchange=e=>{_=e.target.value});let C=b.querySelector(`#printColumnsSelect`);C&&(C.onchange=e=>{v=e.target.value});let w=b.querySelector(`#pageBreakCheckbox`);w&&(w.onchange=e=>{y=e.target.checked}),b.querySelector(`#btnExecutePrint`).onclick=()=>{Je({students:e,isFinal:t,isDraft:r,collegeName:d,collegeLogo:a,electionYear:o,scope:m,dept:h,className:g,sortBy:_,pageBreakPerClass:y,columns:v}),b.remove()}};x(),document.body.appendChild(b)}function Je({students:e,isFinal:t,isDraft:n,collegeName:r,collegeLogo:i=``,electionYear:a=``,scope:o=`all`,dept:s=``,className:c=``,sortBy:l=`serial`,pageBreakPerClass:u=!0,columns:d=`1`}){let f=a||new Date().getFullYear().toString(),p=[...e],m=`Master Nominal Roll`;if(o===`dept`&&s?(p=p.filter(e=>(e.Dept||``).trim().toLowerCase()===s.toLowerCase()),m=`Department of ${s}`):o===`class`&&c&&(p=p.filter(e=>(e.CLASS||``).trim().toLowerCase()===c.toLowerCase()),m=`Class: ${c}`),p.length===0){alert(`No students found for the selected print criteria.`);return}let h=e=>{let t=String(e||``).toUpperCase().trim();return t.includes(`RESEARCH`)||t.includes(`PH.D`)||t.includes(`PHD`)?6e3:/^I\s+M(SC|A|COM|BA|CA)/.test(t)||/^I\s+PG/.test(t)?4e3:/^II\s+M(SC|A|COM|BA|CA)/.test(t)||/^II\s+PG/.test(t)?5e3:/^III\s+M(SC|A|COM|BA|CA)/.test(t)?5500:/^I\s+(B|UG)/.test(t)||/^1ST\s+YEAR/.test(t)?1e3:/^II\s+(B|UG)/.test(t)||/^2ND\s+YEAR/.test(t)?2e3:/^III\s+(B|UG)/.test(t)||/^3RD\s+YEAR/.test(t)?3e3:3500},g=e=>{let t=String(e?.[`Nominal Roll Serial Number`]||e?.serial_number||e?.SL_NO||e?.[`SL. NO`]||``).replace(/\D/g,``),n=parseInt(t,10);return isNaN(n)?999999999:n};l===`dept-class`?p.sort((e,t)=>{let n=String(e.Dept||e.DEPT||``).trim().toUpperCase(),r=String(t.Dept||t.DEPT||``).trim().toUpperCase();if(n!==r)return n.localeCompare(r);let i=String(e.CLASS||``).trim().toUpperCase(),a=String(t.CLASS||``).trim().toUpperCase(),o=h(i),s=h(a);if(o!==s)return o-s;if(i!==a)return i.localeCompare(a);let c=String(e.NAME||``).trim().toUpperCase(),l=String(t.NAME||``).trim().toUpperCase();return c===l?g(e)-g(t):c.localeCompare(l)}):l===`class`?p.sort((e,t)=>{let n=String(e.Dept||``).toUpperCase(),r=String(t.Dept||``).toUpperCase();if(n!==r)return n.localeCompare(r);let i=String(e.CLASS||``).toUpperCase(),a=String(t.CLASS||``).toUpperCase();if(i!==a){let e=h(i),t=h(a);return e===t?i.localeCompare(a):e-t}return String(e.NAME||``).toUpperCase().localeCompare(String(t.NAME||``).toUpperCase())}):p.sort((e,t)=>g(e)-g(t));let _=t?`FINAL NOMINAL ROLL`:`DRAFT NOMINAL ROLL`,v=new Date().toLocaleString(),y=e=>n?`D${e}`:e,b=``;if(o===`class`||u&&o!==`single_table`){let e={};p.forEach(t=>{let n=String(t.CLASS||`UNSPECIFIED CLASS`).toUpperCase();e[n]||(e[n]=[]),e[n].push(t)});let t=Object.keys(e);t.forEach((a,c)=>{let u=e[a];u.sort((e,t)=>{let n=String(e.NAME||``).trim().toUpperCase(),r=String(t.NAME||``).trim().toUpperCase();return n===r?g(e)-g(t):n.localeCompare(r)});let p=u[0].Dept||(o===`dept`?s:`–`),m=c===t.length-1;if(d===`2`){let e=Math.max(1,Math.ceil(u.length/70));for(let t=0;t<e;t++){let o=u.slice(t*70,(t+1)*70),s=Math.ceil(o.length/2),c=o.slice(0,s),d=o.slice(s),h=t===e-1;b+=`
  ...
  `),x.document.close()}async function Ye(e){let t=U();t&&(W(e,`publish`,`
  ...
  `;try{let[n,r,i,a,o]=await Promise.all([C.adminGetSettings(t),C.adminGetNominations(t).catch(()=>[]),C.getPosts().catch(()=>[]),C.getNominalRoll().catch(()=>[]),C.adminGetResults(t).catch(()=>({results:[]}))]);Xe(e,n,r,i,a,o?.results||[],t)}catch(t){e.innerHTML=`<div class="alert alert-error">❌ ${F(t.message)}</div>`}}}function Xe(e,t,r,i,a,o,s){let c=t.nominalRollFinalized===`true`||t.isRollFinalized===`true`,l=!c&&t.draftRollPublished===`true`,u=!c&&!l,d=t.validListPublished===`true`,f=t.finalListPublished===`true`,p=t.resultsPublished===`true`,m=t.resultsLocked===`true`,h=t.countingActive===`true`,g=t.electionYear||new Date().getFullYear(),_=t.collegeName||n.COLLEGE_NAME,v=t.collegeShortName||n.COLLEGE_SHORT_NAME,y=t.collegeLogo||``,b=r.filter(e=>e.status===`Valid`),x=r.filter(e=>e.status===`Valid`&&e.withdrawalStatus!==`Approved`),S=r.filter(e=>e.status===`Valid`&&e.withdrawalStatus===`Approved`),w=new Set(b.map(e=>e.post)).size,T=new Set(x.map(e=>e.post)).size,E={};x.forEach(e=>{E[e.post]=(E[e.post]||0)+1});let D=Object.keys(E).filter(e=>E[e]===1);e.innerHTML=`
    ...
    `),r.document.close()}),e.querySelector(`#btnRefreshPublish`)?.addEventListener(`click`,()=>q(e,s)),e.querySelector(`#publishDraftRollBtn`)?.addEventListener(`click`,async t=>{let n=t.currentTarget;I(n,!0,`Publishing Draft...`);try{await C.adminPublishDraftRoll(s),L(`Draft Nominal Roll published! Serial numbers are set to D1, D2...`,`success`),await q(e,s)}catch(e){L(`Failed: ${e.message}`,`error`),I(n,!1,`📢 Publish Draft Roll`)}}),e.querySelector(`#unpublishDraftRollBtn`)?.addEventListener(`click`,async t=>{let n=t.currentTarget;if(confirm(`Unpublish the Draft Nominal Roll? Students will no longer be able to view it.`)){I(n,!0,`Unpublishing...`);try{await C.adminUnpublishDraftRoll(s),L(`Draft Nominal Roll unpublished.`,`success`),await q(e,s)}catch(e){L(`Failed: ${e.message}`,`error`),I(n,!1,`🚫 Unpublish Draft`)}}}),e.querySelector(`#publishValidBtn`)?.addEventListener(`click`,async t=>{let n=t.currentTarget;if(confirm(`Are you sure you want to publish the valid nominations list? This will be visible to all students.`)){I(n,!0,`Publishing...`);try{await C.adminPublishValidList(s),L(`Valid nominations list published successfully!`,`success`),await q(e,s)}catch(e){L(`Failed: ${e.message}`,`error`),I(n,!1,`📢 Publish Valid Nominations List`)}}}),e.querySelector(`#unpublishValidBtn`)?.addEventListener(`click`,async t=>{let n=t.currentTarget;if(confirm(`Unpublish Valid List?

This will remove it from public view. The Final List will also be unpublished.`)){I(n,!0,`Unpublishing...`);try{await C.adminUnpublishValidList(s),L(`Valid list unpublished.`,`success`),await q(e,s)}catch(e){L(`Failed: ${e.message}`,`error`),I(n,!1,`🚫 Unpublish Valid List`)}}}),e.querySelector(`#publishFinalBtn`)?.addEventListener(`click`,async t=>{let n=t.currentTarget;if(confirm(`Are you sure you want to publish the final nominations list?`)){I(n,!0,`Publishing...`);try{await C.adminPublishFinalList(s),L(`Final nominations list published successfully!`,`success`),await q(e,s)}catch(e){L(`Failed: ${e.message}`,`error`),I(n,!1,`📢 Publish Final Nominations List`)}}}),e.querySelector(`#unpublishFinalBtn`)?.addEventListener(`click`,async t=>{let n=t.currentTarget;if(confirm(`Unpublish Final List?

This will remove the final candidate list from public view.`)){I(n,!0,`Unpublishing...`);try{await C.adminUnpublishFinalList(s),L(`Final list unpublished.`,`success`),await q(e,s)}catch(e){L(`Failed: ${e.message}`,`error`),I(n,!1,`🚫 Unpublish Final List`)}}}),e.querySelector(`#toggleResultsPublishBtn`)?.addEventListener(`click`,async t=>{let n=t.currentTarget,r=p;if(confirm(r?`Hide election results from public view? Public visitors will see counting in progress.`:`Publish election results to the public portal? Results will be immediately visible to all visitors.`)){I(n,!0,`Updating...`);try{L((await C.adminTogglePublishResults(s)).published?`📢 Results published to public view!`:`👁️‍🗨️ Results hidden from public view.`,`success`),await q(e,s)}catch(e){L(`Failed: ${e.message}`,`error`),I(n,!1,r?`🚫 Hide Results from Public`:`📢 Publish Results to Public`)}}}),e.querySelector(`#toggleResultsLockBtn`)?.addEventListener(`click`,async t=>{let n=t.currentTarget,r=m;if(confirm(r?`Unlock election results? Vote entry modifications will be re-enabled.`:`Freeze and lock election results? Further vote entries will be blocked.`)){I(n,!0,`Updating...`);try{L((await C.adminToggleLockResults(s)).locked?`🔒 Results locked and frozen.`:`🔓 Results unlocked for live entry.`,`success`),await q(e,s)}catch(e){L(`Failed: ${e.message}`,`error`),I(n,!1,r?`🔓 Unlock Results`:`🔒 Freeze / Lock Results`)}}}),e.querySelector(`#toggleCountingBtn`)?.addEventListener(`click`,async t=>{let n=t.currentTarget,r=h;if(confirm(r?`Deactivate Counting Mode? Public visitors to the results page will be asked to wait.`:`Activate Counting Mode? Public visitors will see "Counting in Progress".`)){I(n,!0,`Updating...`);try{L((await C.adminToggleCounting(s)).active?`⚡ Live counting mode active!`:`⏳ Counting mode inactive.`,`success`),await q(e,s)}catch(e){L(`Failed: ${e.message}`,`error`),I(n,!1,r?`⏸️ Stop Counting Mode`:`⚡ Set Counting Active`)}}})}async function Ze(e){let t=U();if(t){W(e,`posts`,`
    <div class="text-center py-16">
      <span class="spinner" style="width:2.5rem;height:2.5rem;border-width:4px;"></span>
      <p class="text-slate-400 mt-4 text-sm">Loading posts and departments...</p>
    </div>
  `);try{let[r,i]=await Promise.all([C.adminGetPosts(t).catch(()=>null),C.getNominalRoll().catch(()=>[])]),a=Array.isArray(r)&&r.length>0?r:n.DEFAULT_POSTS,o=new Set;Array.isArray(i)&&i.forEach(e=>{let t=String(e.Dept||e.dept||e.DEPARTMENT||e.Department||``).trim();t&&t!==`-`&&t!==`–`&&o.add(t)});let s=new Set;Array.isArray(a)&&a.forEach(e=>{let t=(e.restrictedDept||(e.deptRestriction&&String(e.post||``).startsWith(`Association Secretary `)?e.post.replace(`Association Secretary `,``).trim():``)).trim();t&&t!==`-`&&t!==`–`&&s.add(t)});let c=[`Botany`,`Chemistry`,`Commerce`,`Computer Science`,`Economics`,`English`,`Hindi`,`History`,`Malayalam`,`Mathematics`,`Physics`,`Psychology`,`Sanskrit`,`Tamil`,`Zoology`],l=o.size>0,u=l?Array.from(o).sort():c,d=Array.from(s).filter(e=>!o.has(e)&&(l?!0:!c.includes(e))).sort(),f=Array.from(new Set([...u,...d])).sort();Qe(e.querySelector(`#adminMain`),a,{nominalDepts:u,otherDepts:d,allDepartments:f,hasNominalRoll:l},t)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${F(t.message)}</div>`}}}function Qe(e,t,n,r){e.innerHTML=`
    <div class="page-enter space-y-6">
  ...
  `);try{let[n,r,i,a,o,s,c]=await Promise.all([C.getNominalRoll(),C.adminGetBooths(t,!0).catch(e=>(console.error(`GetBooths error:`,e),null)),C.adminGetLocations(t,!0).catch(e=>(console.error(`GetLocations error:`,e),null)),C.adminGetPosts(t).catch(()=>[]),C.adminGetFinalNominations(t).catch(()=>C.getFinalNominations()).catch(()=>({active:[]})),C.adminGetBallotPlan(t).catch(()=>null),C.adminGetSettings(t).catch(()=>({}))]);if(r===null||i===null){e.querySelector(`#adminMain`).innerHTML=`
            ...
            ${m.map((e,t)=>`
              <div class="border border-white/10 rounded-lg p-3 bg-white/5 shadow-inner">
                ...
                <div class="text-xs text-slate-500 h-16 overflow-y-auto bg-black/20 rounded p-1">
                  ${e.classes.length?e.classes.map(e=>`<div class="whitespace-nowrap overflow-hidden text-ellipsis">• ${F(e)} (${f[e]?.count||0})</div>`).join(``):`<em class="opacity-30">No classes assigned</em>`}
                </div>
              </div>
            `).join(``)}
          </div>
    ...
    `,_||window.scrollTo(0,i),_=!1,e.querySelector(`#btnClearAll`).addEventListener(`click`,async()=>{let e=m.reduce((e,t)=>e+(t.classes?t.classes.length:0),0);if(e===0){L(`All classes are already unassigned.`,`info`);return}if(confirm(`⚠️ CONFIRM CLEAR ALL CLASS ALLOTMENTS\n\nAre you sure you want to unassign all ${e} class allotment(s) across all booths?\n\nRoom locations and booth counts will be kept intact.\n\nProceed?`)){m.forEach(e=>e.classes=[]);try{await C.adminSaveBooths(t,m),L(`✅ All class allotments cleared and saved to database.`,`success`)}catch(e){L(`Failed to update database: ${e.message}`,`error`)}v()}}),e.querySelector(`#btnPrintRolls`).addEventListener(`click`,()=>{let t=e.querySelector(`#printArea`);t.innerHTML=y(m,r,o,f,s,c);let n=window.open(``,`_blank`);if(!n){alert(`Popup blocked! Please allow popups for this site to print.`);return}n.document.write(`
        <html>
          <head>
...
Do you want to proceed and save this change to the database?`,!confirm(i))return}else if(!confirm(`Confirm setting total polling booths to ${n} and saving to database?`))return;if(n>m.length)for(let e=m.length;e<n;e++)m.push({boothNumber:e+1,roomName:``,classes:[]});else n<m.length&&(m=m.slice(0,n));try{await C.adminSaveBooths(t,m),await C.adminSaveLocations(t,h),L(`✅ Total booths updated to ${n} and saved to database!`,`success`)}catch(e){L(`Failed to persist to database: ${e.message}`,`error`)}v()}),e.querySelectorAll(`.room-name-select`).forEach(e=>{e.addEventListener(`change`,async e=>{let n=e.target.value,r=parseInt(e.target.dataset.idx,10);if(n===`__ADD_NEW__`){e.target.value=m[r].roomName||``,u();let t=a.querySelector(`#newLocationInput`);t&&t.focus();return}if(!n&&m[r].roomName){let t=m[r].roomName;if(!confirm(`Remove assigned room location "${t}" from Booth ${r+1}?`)){e.target.value=t;return}}m[r].roomName=n;try{await C.adminSaveBooths(t,m),await C.adminSaveLocations(t,h),L(`✅ Booth ${r+1} location saved as "${n||`Unassigned`}".`,`success`)}catch(e){L(`Failed to save location: ${e.message}`,`error`)}v()})}),e.querySelectorAll(`.quick-edit-loc-btn`).forEach(e=>{e.addEventListener(`click`,e=>{let t=parseInt(e.currentTarget.dataset.idx,10),n=m[t]?.roomName;if(!n)return;let r=h.indexOf(n);if(u(),r!==-1){g=r,S();let e=a.querySelector(`.loc-edit-input[data-idx="${r}"]`);e&&(e.focus(),e.select())}})});let a=e.querySelector(`#locationsModal`),l=()=>{let e=a.querySelector(`#newLocationInput`);e&&e.value.trim()&&!confirm(`You have entered an unadded location. Discard it?`)||(g=null,a.classList.add(`hidden`),v())},u=()=>{a.classList.remove(`hidden`),S()},d=async e=>{let n=a.querySelector(`.loc-edit-input[data-idx="${e}"]`);if(!n)return;let r=n.value.trim();if(!r){L(`Location name cannot be blank.`,`error`),n.focus();return}let i=h[e];if(r===i){g=null,S();return}if(h.some((t,n)=>n!==e&&t.toLowerCase()===r.toLowerCase())){L(`Location "${r}" already exists.`,`error`),n.focus();return}let o=m.filter(e=>e.roomName===i).length;if(o>0&&!confirm(`Confirm renaming location "${i}" to "${r}"?\n\nThis will update ${o} booth assignment(s).`)){n.value=i;return}h[e]=r,m.forEach(e=>{e.roomName===i&&(e.roomName=r)}),g=null,S();try{await C.adminSaveLocations(t,h),o>0&&await C.adminSaveBooths(t,m),L(`✅ Renamed to "${r}" and saved to database.`,`success`)}catch(e){L(`Failed to save rename: ${e.message}`,`error`)}},S=()=>{let e=a.querySelector(`#locationsCountBadge`);e&&(e.textContent=`${h.length} Locations`);let n=a.querySelector(`#locationsList`);if(!h.length){n.innerHTML=`<div class="p-6 text-center text-slate-500 text-sm italic bg-black/20 rounded-xl border border-white/5">No locations added yet. Add your rooms and halls above.</div>`;return}n.innerHTML=h.map((e,t)=>{let n=m.filter(t=>t.roomName===e);return g===t?`
      ...
      </div>`}),d):`<div class="alert alert-error">❌ Master Ballot Plan not generated.</div>`},x=()=>{m.forEach(e=>{e.classes=[],e.totalStudents=0});let e=m.length;if(e===0)return;let t={};p.forEach(e=>{t[e.dept]||(t[e.dept]={name:e.dept,total:0,classes:[]}),t[e.dept].classes.push(e),t[e.dept].total+=e.count});let n=r.length/e,i=Math.max(n*1.35,120);Object.values(t).sort((e,t)=>t.total-e.total).forEach(t=>{m.sort((e,t)=>e.totalStudents-t.totalStudents);let n=m[0];e>1&&t.total>i?[...t.classes].sort((e,t)=>t.count-e.count).forEach(e=>{m.sort((e,t)=>e.totalStudents-t.totalStudents),m[0].classes.push(e.name),m[0].totalStudents+=e.count}):(t.classes.forEach(e=>n.classes.push(e.name)),n.totalStudents+=t.total)}),m.sort((e,t)=>e.boothNumber-t.boothNumber)};v()}async function rt(e){let t=U();if(t){W(e,`counting`,`
  ...
  `);try{let[n,r,i,a,o,s]=await Promise.all([C.adminGetCountingMatrix(t,!0).catch(()=>null),C.getPosts(),C.adminGetNominations(t).catch(()=>[]),C.adminGetBooths(t),C.getNominalRoll(),C.adminGetSettings(t).catch(()=>({}))]),c=(Array.isArray(i)?i:[]).filter(e=>e.status===`Valid`&&e.withdrawalStatus!==`Approved`);it(e.querySelector(`#adminMain`),t,n,r,c,a,o,s)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${F(t.message)}</div>`}}}function it(e,t,r,i,a,o,s,c={}){let l=c?.collegeName||n.COLLEGE_NAME||`Government Victoria College Palakkad`,u=c?.electionYear||new Date().getFullYear().toString(),d=c?.collegeLogo||``;if(!o.length){e.innerHTML=`<div class="alert alert-error">❌ No booths configured.</div>`;return}if(!i.length){e.innerHTML=`<div class="alert alert-error">❌ No posts configured.</div>`;return}let f=e=>String(e.post||e.name||``),p=t=>{let{matrix:n,formSerials:r,totalRounds:s,roundLabels:c}=t,p=o.length;e.innerHTML=`
    ...
    `,e.querySelector(`#btnInitialGenerate`).addEventListener(`click`,m))}function at(e,t,r,i,a,o=n.COLLEGE_NAME||`Government Victoria College Palakkad`,s=``,c=``){let l=s||new Date().getFullYear().toString(),u=i.length?i.map((e,t)=>`<tr>
  ...
  </div>`}var X=[],ot=!1,st=null;window.addEventListener(`beforeunload`,e=>{X.some(e=>e.status===`pending`||e.status===`syncing`||e.status===`retry`)&&(e.preventDefault(),e.returnValue=`You have unsaved forms syncing in the background. Are you sure you want to leave?`)});function ct(e){X.forEach(t=>{t.payload&&t.payload.forEach(t=>{let n=e.findIndex(e=>String(e.TableNumber)===String(t.TableNumber)&&String(e.Post)===t.Post&&e.CandidateId===t.CandidateId);n>=0?(e[n].Votes=t.Votes,e[n].RoundNumber=t.RoundNumber,e[n].FormSerial=t.FormSerial):e.push({...t})})})}async function lt(e){let t=U();if(t){W(e,`results-entry`,`
  ...
  `;let m=e.querySelector(`#txtSerial`),h=e.querySelector(`#btnLoadBySerial`),g=async()=>{let r=m.value.trim();if(!r)return;let i=f[r];if(!i){L(`Invalid Serial Number: ${r}`,`error`);return}try{I(h,!0,`Loading...`),C.invalidateCache(`adminGetResults`);let o=await C.adminGetResults(t,!0).catch(()=>[]);a.length=0,a.push(...o),ct(a),_(n[i.t].boothNumber,i.postName,r,i.r+1),Z(e,a,p)}catch{ct(a),_(n[i.t].boothNumber,i.postName,r,i.r+1),Z(e,a,p)}finally{I(h,!1,`Load Form`)}};h.addEventListener(`click`,g),m.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),g())}),m.addEventListener(`keypress`,e=>{e.key===`Enter`&&g()}),e.querySelector(`#btnLoadForm`).addEventListener(`click`,async()=>{let r=e.querySelector(`#selTable`).value,i=e.querySelector(`#selPost`).value;if(!r||!i){L(`Select Table and Post`,`warning`);return}let o=n.findIndex(e=>String(e.boothNumber)===String(r)),s=null,c=null;if(o>=0){for(let e=0;e<u[o].length;e++)if(l(u[o][e])===i){c=e+1,s=d[`${o}-${e}`];break}}try{I(e.querySelector(`#btnLoadForm`),!0,`...`),C.invalidateCache(`adminGetResults`);let n=await C.adminGetResults(t,!0).catch(()=>[]);a.length=0,a.push(...n),ct(a),_(r,i,s,c),Z(e,a,p)}catch{ct(a),_(r,i,s,c),Z(e,a,p)}finally{I(e.querySelector(`#btnLoadForm`),!1,`Load`)}});let _=(n,r,o,s)=>{let l=e.querySelector(`#entryFormArea`),u=i.filter(e=>e.post===r).sort((e,t)=>String(e.candidateName||``).localeCompare(String(t.candidateName||``)));if(u.length===0){l.innerHTML=`<div class="alert alert-warning">No candidates found for ${F(r)}.</div>`;return}if(u.length===1){l.innerHTML=`
    ...
    >${e}</button>`}).join(``),r.querySelectorAll(`button[data-serial]`).forEach(r=>{r.addEventListener(`click`,()=>{let i=r.dataset.id;if(i){let r=X.find(e=>e.id===i);r&&(r.status=`retry`,Z(e,t,n),dt(e,t,n))}let a=r.dataset.serial,o=e.querySelector(`#txtSerial`),s=e.querySelector(`#btnLoadBySerial`);o&&a&&(o.value=a,s?s.click():o.dispatchEvent(new KeyboardEvent(`keypress`,{key:`Enter`,bubbles:!0})),e.querySelector(`#entryFormArea`)?.scrollIntoView({behavior:`smooth`,block:`start`}))})});let g=e.querySelector(`#pendingList`),_=e.querySelector(`#pendingTabCount`),v=s.filter(e=>(o[String(e)]||`pending`)===`pending`);if(_&&(_.textContent=v.length),g&&(v.length===0?g.innerHTML=`<tr><td colspan="3" class="px-3 py-8 text-center text-slate-500 italic text-sm">🎉 All forms entered!</td></tr>`:(g.innerHTML=v.map(e=>{let t=n[String(e)]||{};return`
  ...
  `);let r=e.querySelector(`#adminMain`),i=[],a=null;try{let[e,n,r]=await Promise.all([C.adminGetPosts(t).catch(()=>[]),C.adminGetBallotConfig(t).catch(()=>null),C.adminGetBallotPlan(t).catch(()=>null)]);i=e,a=n}catch(e){console.warn(`Error fetching initial ballot data:`,e)}let o=e=>{let t=String(e.post||e.name||``).toUpperCase();return t.includes(`ASSOCIATION`)||t.includes(`ASSOC`)||!!e.deptRestriction},s=e=>{let t=String(e.post||e.name||``).toUpperCase();return t.includes(`UUC`)||t.includes(`UNIVERSITY UNION COUNCILLOR`)},c=e=>{if(o(e)||s(e))return!1;let t=String(e.post||e.name||``).toUpperCase();return t.includes(`REPRESENTATIVE`)||t.includes(`REP`)},l=e=>!o(e)&&!c(e),u=i.filter(l),d=e=>{let t=String(e||``).toLowerCase();return t.includes(`chairman`)&&!t.includes(`vice`)?`🏆`:t.includes(`vice chairman`)?`🥈`:t.includes(`joint secretary`)?`🤝`:t.includes(`secretary`)&&!t.includes(`fine arts`)?`📝`:t.includes(`councillor`)||t.includes(`uuc`)?`🏛️`:t.includes(`editor`)?`📰`:t.includes(`fine arts`)||t.includes(`arts`)?`🎨`:t.includes(`captain`)||t.includes(`sports`)?`⚽`:`🎖️`},f=[{id:`gen_1`,partNumber:1,title:`General Union Posts - Main`,shortCode:`G1`,bookPrefix:`GB1-`,paperSize:`A3`,posts:[]},{id:`gen_2`,partNumber:2,title:`Additional General Ballot (Arts, Sports & Editorial)`,shortCode:`G2`,bookPrefix:`GB2-`,paperSize:`A3`,posts:[]}],p=a||{isSplit:!1,ballots:f};(!Array.isArray(p.ballots)||p.ballots.length===0)&&(p.ballots=f),p.ballots.length===1&&p.ballots.push({id:`gen_2`,partNumber:2,title:`Additional General Ballot (Arts, Sports & Editorial)`,shortCode:`G2`,bookPrefix:`GB2-`,paperSize:`A3`,posts:[]});let m=new Set;p.isSplit&&p.ballots[1]&&Array.isArray(p.ballots[1].posts)&&p.ballots[1].posts.forEach(e=>m.add(e));let h=()=>{let e=m.size>0;p.isSplit=e;let t=u.map(e=>e.post),n=t.filter(e=>m.has(e)),r=t.filter(e=>!m.has(e));p.ballots[0].posts=r,p.ballots[0].shortCode=e?`G1`:`G`,p.ballots[0].bookPrefix=e?`GB1-`:`GB`,p.ballots[1]||(p.ballots[1]={id:`gen_2`,partNumber:2,title:`Additional General Ballot (Arts, Sports & Editorial)`,shortCode:`G2`,bookPrefix:`GB2-`,paperSize:`A3`,posts:[]}),p.ballots[1].posts=n,p.ballots[1].shortCode=`G2`,p.ballots[1].bookPrefix=`GB2-`};h();let g=()=>{let e=!!p.isSplit,t=p.ballots[0].posts||[],n=p.ballots[1]&&p.ballots[1].posts||[];r.innerHTML=`
    ...
    `),t.document.close()},y=async(e=`all`)=>{let r,i,a,s;try{[r,i,a,s]=await Promise.all([C.adminGetPosts(t),C.adminGetFinalNominations(t).catch(async()=>{let e=await C.adminGetNominations(t).catch(()=>[]);return{active:e.filter(e=>e.status!==`Rejected`&&e.withdrawalStatus!==`Approved`),withdrawn:e.filter(e=>e.withdrawalStatus===`Approved`),isPublished:!1}}),C.getPublicSchedule(),C.adminGetSettings(t).catch(()=>({}))])}catch(e){throw Error(e.message.includes(`not published`)?`Final List Not Published. Please finalize and publish the list first.`:e.message)}let u=s.collegeName||n.COLLEGE_NAME;s.collegeShortName||n.COLLEGE_SHORT_NAME;let d=s.collegeLogo||``,f=s.electionYear||a.electionYear||new Date().getFullYear().toString(),m=Array.isArray(i)?i:i?.active||[];if(m.length===0)throw Error(`No active candidates found. Please ensure candidates are nominated and verified.`);let h=r.filter(e=>m.filter(t=>t.post===e.post).length>1),g=!!p.isSplit,_=``,v=(e,t)=>{if(!t||t.length===0)return``;let n=(e.paperSize||`A3`).toLowerCase(),r=e.shortCode===`G`?`G`:(e.shortCode||`G1`)+`-`,i=e.title||`OFFICIAL BALLOT PAPER (GENERAL)`,a=[...t].sort((e,t)=>{let n=e.post.toLowerCase(),r=t.post.toLowerCase();return n.includes(`chairman`)&&!n.includes(`vice`)?-1:r.includes(`chairman`)&&!r.includes(`vice`)?1:n.includes(`vice chairman`)?-1:r.includes(`vice chairman`)||n.includes(`university union councillor`)||n.includes(`uuc`)?1:r.includes(`university union councillor`)||r.includes(`uuc`)?-1:0}),o=``,s=``;return a.forEach((e,t)=>{let n=m.filter(t=>t.post===e.post).sort((e,t)=>String(e.candidateName||``).localeCompare(String(t.candidateName||``))),r=`
      ...
      `)}catch(e){L(e.message,`error`)}};g()}function pt(e){let t=U();if(!t)return;W(e,`testing`,`
...
Are you absolutely sure?`))return;I(t,!0,`🗑️ Wiping...`);let i=n.querySelector(`#wipeStatus`);i.innerHTML=``;try{await C.adminWipeData(r),n.querySelector(`#wipePasswordInput`).value=``,i.innerHTML=`
        ...
        </div>`,L(`All data wiped successfully.`,`success`)}catch(e){i.innerHTML=`<div class="alert alert-error mt-3">❌ ${F(e.message)}</div>`,L(`Failed: ${e.message}`,`error`)}finally{I(t,!1,`🗑️ Permanently Wipe All Data`)}})}async function mt(e){let t=U();if(!t)return;W(e,`results`,`
  ...
  `,e.querySelector(`#btnPrintOfficial`).addEventListener(`click`,()=>{let e=`
    ...
    `),t.document.close()});let _=e.querySelector(`#btnAdminRefreshResults`);_&&c&&(_.onclick=async()=>{_.disabled=!0,_.innerHTML=`<span>⏳</span> Refreshing...`;try{await c(!0),L(`Election results refreshed with latest counts.`,`success`)}catch(e){L(`Refresh failed: ${e.message}`,`error`),_.disabled=!1,_.innerHTML=`<span>🔄</span> Refresh Results`}});let v=e.querySelector(`#btnToggleCounting`);v&&(v.onclick=async()=>{if(confirm(m?`Set Counting Mode Inactive? Visitors to the public portal will be asked to wait for counting to begin.`:`Set Counting Mode Active? Visitors to the public portal will see "Counting in Progress".`)){v.disabled=!0,v.textContent=`Please wait...`;try{m=(await C.adminToggleCounting(t)).active,o.countingActive=m?`true`:`false`,L(m?`⚡ Counting mode active! Public sees "Counting in Progress".`:`⏳ Counting mode inactive. Public asked to wait.`,`success`),ht(e,t,n,r,i,a,o,s,c)}catch(e){L(e.message,`error`),v.disabled=!1,v.textContent=m?`⏸️ Stop Counting`:`⚡ Set Counting Active`}}});let y=e.querySelector(`#btnToggleLock`);y&&(y.onclick=async()=>{if(confirm(f?`Unlock election results? Vote entries will be re-enabled.`:`Lock and freeze election results? No further vote entries will be allowed.`)){y.disabled=!0,y.textContent=`Please wait...`;try{f=(await C.adminToggleLockResults(t)).locked,o.resultsLocked=f?`true`:`false`,L(f?`🔒 Results locked and frozen.`:`🔓 Results unlocked for editing.`,`success`),ht(e,t,n,r,i,a,o,s,c)}catch(e){L(e.message,`error`),y.disabled=!1,y.textContent=f?`🔓 Unlock Results`:`🔒 Freeze / Lock`}}});let b=e.querySelector(`#btnTogglePublic`);b&&(b.onclick=async()=>{if(confirm(p?`Hide election results from public view? The public portal will show counting in progress.`:`Publish election results to the public portal? Anyone visiting the site will see live results.`)){b.disabled=!0,b.textContent=`Please wait...`;try{p=(await C.adminTogglePublishResults(t)).published,o.resultsPublished=p?`true`:`false`,L(p?`📢 Results published to public portal!`:`👁️‍🗨️ Results hidden from public view.`,`success`),ht(e,t,n,r,i,a,o,s,c)}catch(e){L(e.message,`error`),b.disabled=!1,b.textContent=p?`👁️‍🗨️ Hide Public View`:`📢 Publish to Public`}}})}var gt=`election_results_cache`,_t=`election_results_last_fetch`,vt=300*1e3;async function yt(e){e.innerHTML=`
    <div class="page-enter min-h-screen">
      <header class="no-print sticky top-0 z-10 border-b border-white/10 glass">
        <div class="max-w-5xl mx-auto px-6 py-3 flex items-center justify-between">
          <div class="flex items-center gap-4">
  ...
  `;let t=e.querySelector(`#cacheTimer`),n=e.querySelector(`#btnRefresh`),r=()=>{let e=localStorage.getItem(_t);if(!e){t.textContent=``,n.disabled=!1,n.classList.remove(`opacity-50`,`cursor-not-allowed`);return}let r=parseInt(e,10)+vt,i=Math.max(0,r-Date.now());i<=0?(t.textContent=`Live Update Available`,t.classList.add(`text-green-400`),n.disabled=!1,n.classList.remove(`opacity-50`,`cursor-not-allowed`,`pointer-events-none`)):(t.textContent=`Update in ${Math.floor(i/6e4)}:${Math.floor(i%6e4/1e3).toString().padStart(2,`0`)}`,t.classList.remove(`text-green-400`),n.disabled=!0,n.classList.add(`opacity-50`,`cursor-not-allowed`,`pointer-events-none`))};setInterval(r,1e3),r(),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`)),n.addEventListener(`click`,t=>{if(n.disabled||n.classList.contains(`pointer-events-none`)){t.preventDefault();return}bt(e.querySelector(`#resultsMain`),!0)}),await bt(e.querySelector(`#resultsMain`))}async function bt(e,t=!1){try{let n=localStorage.getItem(_t),r=localStorage.getItem(gt),i,a,s=!1,c=!1,l=!1;if(!t&&n&&r&&Date.now()-parseInt(n,10)<vt)try{let t=JSON.parse(r);i=t.posts,a=t.results;let n=t.schedule||{};s=t.isCountingActive||n.countingActive===`true`,c=t.isResultsPublished||n.resultsPublished===`true`,l=t.isResultsLocked||!1,u(e,n.electionYear||new Date().getFullYear())}catch{localStorage.removeItem(gt),localStorage.removeItem(_t),i=null}if(!i){e.innerHTML=`
      ...
      `,t&&(C.invalidateCache(`getResults`),C.invalidateCache(`getPosts`),C.invalidateCache(`getPublicSchedule`),C.invalidateCache(`getSettings`));let n,r,o;[i,r,n,o]=await Promise.all([C.getPosts(),C.getResults(t).catch(()=>({results:[],published:!1,countingActive:!1})),C.getPublicSchedule().catch(()=>({})),C.getSettings().catch(()=>({}))]),a=Array.isArray(r)?r:r?.results||[],s=r&&r.countingActive===!0||n?.countingActive===`true`||o?.countingActive===`true`,c=r&&r.published===!0||n?.resultsPublished===`true`||o?.resultsPublished===`true`,l=r&&r.locked===!0||o?.resultsLocked===`true`,localStorage.setItem(_t,Date.now().toString()),localStorage.setItem(gt,JSON.stringify({posts:i,results:a,schedule:n,isCountingActive:s,isResultsPublished:c,isResultsLocked:l})),u(e,n?.electionYear||o?.electionYear||new Date().getFullYear())}function u(e,t){let n=e.closest(`.page-enter`)?.querySelector(`h1`);n&&(n.textContent=`Live Election Results ${t}`)}if(a.length===0||!c){s?(e.innerHTML=`
        ...
        `,e.querySelector(`#btnCountingRefresh`)?.addEventListener(`click`,()=>bt(e,!0))):(e.innerHTML=`
      ...
      `:e.innerHTML=f}catch(t){e.innerHTML=`<div class="alert alert-error">❌ Failed to load results: ${F(t.message)}</div>`}}async function xt(e){e.innerHTML=`
  ...
  `;try{let[t,n]=await Promise.all([C.getNominalRoll().catch(()=>[]),C.getSettings().catch(()=>({}))]);St(e,t,n)}catch(t){e.innerHTML=`<div class="alert alert-error">❌ ${F(t.message)}</div>`}}function St(e,t,r){let i=r.nominalRollFinalized===`true`||r.isRollFinalized===`true`,a=!i&&r.draftRollPublished===`true`,o=i||a,s=r.collegeName||n.COLLEGE_NAME;if(!o){e.innerHTML=`
  ...
  `,v=()=>{let n=c.filter(e=>[e.NAME,e.CLASS,e[`ADMISION NO`]||e[`ADMISSION NO`],e[`Nominal Roll Serial Number`],e.Dept].some(e=>String(e||``).toLowerCase().includes(u.toLowerCase())));d===`dept-class`?n.sort((e,t)=>{let n=String(e.Dept||``).trim().toUpperCase(),r=String(t.Dept||``).trim().toUpperCase();if(n!==r)return n.localeCompare(r);let i=String(e.CLASS||``).trim().toUpperCase(),a=String(t.CLASS||``).trim().toUpperCase(),o=m(i),s=m(a);if(o!==s)return o-s;if(i!==a)return i.localeCompare(a);let c=String(e.NAME||``).trim().toUpperCase(),u=String(t.NAME||``).trim().toUpperCase();return c===u?l(e)-l(t):c.localeCompare(u)}):d===`name`?n.sort((e,t)=>String(e.NAME||``).trim().toUpperCase().localeCompare(String(t.NAME||``).trim().toUpperCase())):n.sort((e,t)=>l(e)-l(t));let y=Math.max(1,Math.ceil(n.length/50));f>y&&(f=y),f<1&&(f=1);let b=(f-1)*50,x=Math.min(b+50,n.length),S=n.slice(b,x),w=``;if(y>1){w=`
        ...
        <div class="glass rounded-xl p-4 flex flex-col md:flex-row gap-3 items-center w-full shadow-lg mb-2">
          ...
          <div class="w-full md:w-60 shrink-0">
            <select id="adminArrangeSelect" class="field text-xs bg-slate-900 border-white/10 text-white w-full py-2">
              <option value="dept-class" ${d===`dept-class`?`selected`:``}>🏢 Arrange: Dept ➔ Class ➔ Name (A-Z)</option>
...
This will lock the list and prevent any further additions, edits, or deletions.`))return;let r=async(i=!1)=>{I(n.target,!0,`Finalizing...`);try{let a=await C.adminFinalizeRoll(t,{matchNominations:i});if(a&&a.requiresMatching)return I(n.target,!1,`🔒 Finalize & Lock Roll`),confirm(`⚠️ ${a.count} existing nominations found!\n\nBecause you edited the Nominal Roll, their Serial Numbers have shifted.\n\nWould you like the system to automatically remap them using their Admission Numbers?`)?await r(!0):void 0;L(`Nominal Roll Finalized & Locked Successfully!`,`success`),await Q(e,t)}catch(e){L(e.message,`error`),I(n.target,!1,`🔒 Finalize & Lock Roll`)}};await r(!1)};e.querySelector(`#btnFinalize`)&&(e.querySelector(`#btnFinalize`).onclick=M),e.querySelector(`#btnFinalizeTop`)&&(e.querySelector(`#btnFinalizeTop`).onclick=M);let N=()=>{let t=e.querySelector(`#unfinalizeModal`),n=e.querySelector(`#unfinalizePwdInput`),r=e.querySelector(`#unfinalizeError`);n&&(n.value=``),r&&(r.textContent=``,r.classList.add(`hidden`)),t&&(t.classList.remove(`hidden`),n&&setTimeout(()=>n.focus(),50))};e.querySelector(`#btnUnfinalize`)&&(e.querySelector(`#btnUnfinalize`).onclick=N),e.querySelector(`#btnUnfinalizeBanner`)&&(e.querySelector(`#btnUnfinalizeBanner`).onclick=N),e.querySelector(`#btnCancelUnfinalize`)&&(e.querySelector(`#btnCancelUnfinalize`).onclick=()=>{e.querySelector(`#unfinalizeModal`)?.classList.add(`hidden`)});let P=async()=>{let n=e.querySelector(`#unfinalizePwdInput`),r=(n?.value||``).trim(),i=e.querySelector(`#unfinalizeError`),a=e.querySelector(`#btnConfirmUnfinalize`);if(!r){i&&(i.textContent=`❌ Please enter your admin password.`,i.classList.remove(`hidden`)),n?.focus();return}I(a,!0,`Unlocking...`),i&&i.classList.add(`hidden`);try{await C.adminUnfinalizeRoll(r),L(`Nominal Roll Unlocked! You can now add, edit, or delete students.`,`success`),e.querySelector(`#unfinalizeModal`)?.classList.add(`hidden`),await Q(e,t)}catch(e){let t=e.message&&(e.message.includes(`UNAUTHORIZED`)||e.message.includes(`password`))?`Incorrect admin password. Please try again.`:e.message||`Incorrect password`;i&&(i.textContent=`❌ ${t}`,i.classList.remove(`hidden`)),L(t,`error`),I(a,!1,`Confirm & Unlock`),n?.focus()}};e.querySelector(`#btnConfirmUnfinalize`)&&(e.querySelector(`#btnConfirmUnfinalize`).onclick=P),e.querySelector(`#unfinalizePwdInput`)&&(e.querySelector(`#unfinalizePwdInput`).onkeydown=e=>{e.key===`Enter`&&P()}),e.querySelector(`#btnPrintRoll`)&&(e.querySelector(`#btnPrintRoll`).onclick=()=>{qe({students:c,isFinal:a,isDraft:o,collegeName:r.collegeName,collegeLogo:r.collegeLogo,electionYear:r.electionYear,initialSort:d===`dept-class`?`dept-class`:d===`name`?`class`:`serial`})})};v()}async function Tt(e){let t=U();t&&(W(e,`schedule`,`
  ...
  `),await fe(e.querySelector(`#nominationWrapper`)))}async function kt(e){let t=U();if(!t)return;W(e,`audit`,`
    <div class="page-enter space-y-8">
      <div class="flex items-end justify-between">
        <div>
  ...
  `);let n=e.querySelector(`#btnRunAudit`),r=e.querySelector(`#auditResults`);n.addEventListener(`click`,async()=>{n.disabled=!0,n.innerHTML=`<span class="spinner w-4 h-4 mr-2 border-2"></span> Running Audit...`,r.innerHTML=`
    ...
    `;try{let e=(await C.adminRunAudit(t)).report,n=(e,t)=>t.pass?`
      ...
      `,e.rollCheck.pass&&e.serialCheck.pass&&e.resultsCheck.pass&&e.formsCheck.pass?r.innerHTML=`
         ...
         `+r.innerHTML,L(`Audit completed.`,`info`)}catch(e){r.innerHTML=`<div class="alert alert-error">❌ Audit failed: ${F(e.message)}</div>`,L(e.message,`error`)}finally{n.disabled=!1,n.innerHTML=`<span class="mr-2">🔍</span> Run Full System Audit`}})}async function At(e){let t=U();if(t){W(e,`settings`,`
...
5. In the event of an equality of votes between two candidates, the result shall be decided by the Returning Officer drawing lots in the presence of the candidates.`}]}async function Ft(e){let t=U();t&&(W(e,`notices`,`
    <div class="text-center py-16">
      <span class="spinner" style="width:2.5rem;height:2.5rem;border-width:4px;"></span>
      <p class="text-slate-400 mt-4 text-sm">Loading notices and polling booth poster center...</p>
    </div>
  `),await It(e.querySelector(`#adminMain`),t))}async function It(e,t){if(e)try{let[r,i]=await Promise.all([C.adminGetNotices(t,!0).catch(()=>({})),C.getNominalRoll().catch(()=>[])]),a=r.settings||{},o=r.schedule||{},s=Array.isArray(r.booths)?r.booths:[];Array.isArray(r.locations)&&r.locations;let c=Array.isArray(r.posts)&&r.posts.length>0?r.posts:n.DEFAULT_POSTS||[],l=Array.isArray(r.notices)?r.notices:[];l.length===0&&(l=Pt(a,o,s,c));let u={};i.forEach(e=>{let t=String(e.CLASS||``).trim(),n=String(e.Dept||``).trim(),r=t.toUpperCase().includes(`RESEARCH`)||t.toUpperCase().includes(`SCHOLAR`)||t.toUpperCase().includes(`PHD`)?`RESEARCH SCHOLAR - ${n}`:t;r&&(u[r]||(u[r]={name:r,dept:n,count:0}),u[r].count++)}),s.forEach(e=>{let t=Array.isArray(e.classes)?e.classes:[];e.totalStudents=0,t.forEach(t=>{u[t]&&(e.totalStudents+=u[t].count)})}),Lt(e,t,a,o,l,s,u,c)}catch(t){console.error(`Error loading admin notices:`,t),e.innerHTML=`<div class="alert alert-error">❌ ${F(t.message||`Failed to load notices`)}</div>`}}function Lt(e,t,r,i,a,o,s,c=[]){r.collegeName||n.COLLEGE_NAME,r.collegeShortName||n.COLLEGE_SHORT_NAME,r.electionYear||new Date().getFullYear();let l=a.filter(e=>e.isPublished!==!1&&e.isPublished!==`false`).length,u=o.reduce((e,t)=>e+(t.totalStudents||0),0);e.innerHTML=`
    <div class="page-enter space-y-6">
                ...
                <div class="glass p-5 rounded-2xl border border-white/10 hover:border-indigo-500/40 transition flex flex-col justify-between space-y-4">
                  <div class="space-y-3">
                    ...
                    <div>
                      ...
                      <div class="text-base font-bold text-white mt-0.5">📍 ${F(e.roomName||`Room Not Specified`)}</div>
                    </div>
                  ...
                  <div class="pt-3 border-t border-white/10 flex items-center justify-between">
                    ...
                    <button class="btn btn-secondary btn-sm print-single-booth-btn flex items-center gap-1 text-xs" data-num="${F(e.boothNumber)}">
              ...
              <tbody class="divide-y divide-white/5">
                ${a.length?a.map(e=>{let t=e.isPublished!==!1&&e.isPublished!==`false`;return`
                    <tr class="hover:bg-white/5 transition">
                      ...
                      <td class="p-3">
                        <div class="font-bold text-white text-sm leading-snug">${F(e.title)}</div>
                        <div class="text-[11px] font-mono text-slate-400 mt-0.5">${F(e.refNo||`N/A`)}</div>
                      </td>
                      <td class="p-3">
                        <span class="px-2.5 py-1 rounded-full text-[10px] font-bold bg-indigo-500/10 text-indigo-300 border border-indigo-500/20">
                          ${F(e.category||`General`)}
                        </span>
                      </td>
                      ...
                      <td class="p-3 text-right">
                        <div class="flex items-center justify-end gap-1.5">
                          <button class="btn btn-secondary btn-sm py-1 px-2 print-notice-btn text-xs" data-id="${F(e.id)}" title="Print Official Letterhead">
                            🖨️
                          </button>
                          <button class="btn btn-secondary btn-sm py-1 px-2 edit-notice-btn text-xs" data-id="${F(e.id)}" title="Edit Notice">
                            ✏️
                          </button>
                          <button class="btn btn-secondary btn-sm py-1 px-2 toggle-notice-btn text-xs" data-id="${F(e.id)}" title="${t?`Unpublish from Public Portal`:`Publish to Public Portal`}">
                            ${t?`🚫`:`📢`}
                          </button>
                          <button class="btn btn-sm py-1 px-2 delete-notice-btn text-xs bg-rose-500/20 text-rose-300 hover:bg-rose-500/30" data-id="${F(e.id)}" title="Delete Notice">
                            🗑️
                          </button>
                        </div>
                      </td>
          ...
          <div id="classIndexGrid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            ${Object.values(s).sort((e,t)=>e.name.localeCompare(t.name)).map(e=>{let t=o.find(t=>(Array.isArray(t.classes)?t.classes:[]).includes(e.name)),n=t?t.boothNumber:``;return`
                <div class="glass p-3.5 rounded-xl border border-white/10 flex items-center justify-between class-index-card" 
                     ...
                     data-booth="${F(n)}">
                  <div>
                    <div class="font-bold text-white text-xs">${F(e.name)}</div>
                    <div class="text-[10px] text-slate-400 mt-0.5">${F(e.dept)} • ${e.count} Voters</div>
                  </div>
                  <div class="text-right">
                    ${t?`
                      <span class="font-black text-indigo-300 text-xs bg-indigo-500/20 px-2 py-1 rounded border border-indigo-500/30">
                        Booth ${F(t.boothNumber)}
                      </span>
                      <div class="text-[10px] text-slate-400 mt-1">📍 ${F(t.roomName||`Hall`)}</div>
                    `:`
...
`);var Bt=document.getElementById(`sync-status`),Vt=document.getElementById(`sync-icon`),Ht=document.getElementById(`sync-text`);m(e=>{e===`saving`?(Bt.classList.remove(`translate-y-[-150%]`,`opacity-0`),Bt.classList.add(`translate-y-0`,`opacity-100`),Vt.className=`animate-spin inline-block text-indigo-400`,Vt.innerHTML=`&#8635;`,Ht.innerText=`Saving changes...`):e===`saved`?(Vt.className=`inline-block text-emerald-400`,Vt.innerHTML=`&#10003;`,Ht.innerText=`All changes saved`):e===`idle`&&(Bt.classList.remove(`translate-y-0`,`opacity-100`),Bt.classList.add(`translate-y-[-150%]`,`opacity-0`))}),C.initPublicData();