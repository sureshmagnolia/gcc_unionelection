var e=Object.defineProperty,t=(t,n)=>{let r={};for(var i in t)e(r,i,{get:t[i],enumerable:!0});return n||e(r,Symbol.toStringTag,{value:`Module`}),r};(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var n={API_BASE_URL:`/api`,APPS_SCRIPT_URL:`https://script.google.com/macros/s/AKfycbw29XuhvNI4cV-tlAWz5IaRrWPY1T9P7ZiQJbu-7za9226PyEqlhuLOrOMTG2QulzzOog/exec`,ELECTION_DATE:`2026-10-12`,COLLEGE_NAME:`Government Victoria College, Palakkad`,COLLEGE_SHORT_NAME:`GVC`,DEFAULT_POSTS:[{post:`The Chairman`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!1},{post:`The Vice Chairman`,femaleOnly:!0,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!1},{post:`The Secretary`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!1},{post:`The Joint Secretary`,femaleOnly:!0,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!1},{post:`The Chief Student Editor`,femaleOnly:!1,finalYearIneligible:!0,yearRestriction:``,deptRestriction:!1},{post:`The Secretary Fine Arts`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!1},{post:`The General Captain For Sports And Games`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!1},{post:`The University Union Councillor`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!1},{post:`I UG Representative`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:`1`,deptRestriction:!1},{post:`II UG Representative`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:`2`,deptRestriction:!1},{post:`III UG Representative`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:`3`,deptRestriction:!1},{post:`PG Representative`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:`PG`,deptRestriction:!1},{post:`Association Secretary Botany`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Chemistry`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Commerce`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Computer Science`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Economics`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary English`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Hindi`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary History`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Malayalam`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Mathematics`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Physics`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Psychology`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Sanskrit`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Tamil`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Zoology`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0}]},r=t({router:()=>o}),i={},a=`/`,o={on(e,t){return i[e]=t,this},setDefault(e){return a=e,this},navigate(e,t={}){window.history.pushState({path:e,params:t},``,`#${e}`),this._resolve(e,t)},start(){window.addEventListener(`popstate`,e=>{let{path:t,params:n}=e.state||{path:a,params:{}};this._resolve(t,n)});let e=window.location.hash.replace(`#`,``)||a;this._resolve(e,{})},_resolve(e,t){let n=i[e]||i[a];n&&n(t)}},s=n.API_BASE_URL||`/api`,c=n.APPS_SCRIPT_URL,l={};function u(){let e=sessionStorage.getItem(`adminSessionToken`)||localStorage.getItem(`adminSessionToken`);return e?{Authorization:`Bearer ${e}`}:{}}function d(){localStorage.removeItem(`adminPwd`),localStorage.removeItem(`adminLoginDate`),localStorage.removeItem(`adminSessionToken`),sessionStorage.removeItem(`adminSessionToken`),l={},alert(`⚠️ Session expired or invalid admin credentials. Please login again.`),window.location.hash=`/admin`}function f(e){Object.keys(l).forEach(t=>{t.includes(e)&&delete l[t]})}async function p(e){if(c)try{fetch(c,{method:`POST`,headers:{"Content-Type":`text/plain;charset=utf-8`},body:JSON.stringify(e)}).catch(e=>console.warn(`[Secondary Sheets Backup Sync warning]`,e.message))}catch(e){console.warn(`[Secondary Sheets Backup Sync error]`,e.message)}}async function m(e,t={}){let n={"Content-Type":`application/json`,...u(),...t.headers||{}},r=await fetch(`${s}${e}`,{...t,headers:n});if(r.status===401)throw d(),Error(`UNAUTHORIZED`);if(!r.ok){let e=await r.json().catch(()=>({}));throw Error(e.error||`HTTP ${r.status}`)}return await r.json()}var h={invalidateCache:f,initPublicData:async()=>{let e=[h.getSettings().catch(()=>null),h.getPosts().catch(()=>null),h.getValidNominations().catch(()=>null),h.getFinalNominations().catch(()=>null)];await Promise.all(e)},initAdminData:async e=>{let t=[h.adminGetNominations(e).catch(()=>null),h.adminGetSettings(e).catch(()=>null),h.adminGetPosts(e).catch(()=>null)];await Promise.all(t)},getNominalRoll:()=>m(`/nominal-roll`),getStudentBySerial:e=>m(`/nominal-roll?serial=${e}`),getPosts:async()=>{let e=`getPosts`;if(l[e])return l[e];let t=await m(`/admin/posts`);return l[e]=t,t},getNomination:e=>m(`/find-nomination?id=${e}`),getPublicNominations:()=>m(`/admin/verify`),getValidNominations:async()=>(await m(`/admin/verify`).catch(()=>[])).filter(e=>e.status===`Valid`),getFinalNominations:async()=>(await m(`/admin/verify`).catch(()=>[])).filter(e=>e.status===`Valid`&&e.withdrawalStatus!==`Approved`),submitNomination:async e=>{let t=await m(`/submit-nomination`,{method:`POST`,body:JSON.stringify(e)});return p({action:`submitNomination`,...e,id:t.id}),t},submitWithdrawal:async(e,t)=>{let n=await m(`/withdraw-nomination`,{method:`POST`,body:JSON.stringify({id:e,reason:t})});return p({action:`submitWithdrawal`,id:e,reason:t}),n},adminLogin:async e=>{let t=await m(`/admin/login`,{method:`POST`,body:JSON.stringify({password:e})});return t.token&&(sessionStorage.setItem(`adminSessionToken`,t.token),localStorage.setItem(`adminSessionToken`,t.token)),t},adminGetNominations:e=>m(`/admin/verify`),adminVerifyNomination:async(e,t,n,r)=>{let i=await m(`/admin/verify`,{method:`POST`,body:JSON.stringify({id:t,status:n,remarks:r})});return p({action:`adminVerifyNomination`,id:t,status:n,remarks:r}),{ok:!0,res:i}},adminApproveWithdrawal:async(e,t)=>{let n=await m(`/admin/withdrawals`,{method:`POST`,body:JSON.stringify({id:t,withdrawalStatus:`Approved`})});return p({action:`adminApproveWithdrawal`,id:t}),{ok:!0,res:n}},adminDirectWithdrawal:async(e,t)=>h.adminApproveWithdrawal(e,t),adminGetSettings:()=>m(`/admin/settings`),adminUpdateSettings:async(e,t)=>{let n=await m(`/admin/settings`,{method:`POST`,body:JSON.stringify({settings:t})});return p({action:`adminUpdateSettings`,settings:t}),{ok:!0,res:n}},adminPublishValidList:e=>h.adminUpdateSettings(e,{validListPublished:`true`}),adminPublishFinalList:e=>h.adminUpdateSettings(e,{finalListPublished:`true`}),adminUnpublishValidList:e=>h.adminUpdateSettings(e,{validListPublished:`false`,finalListPublished:`false`}),adminUnpublishFinalList:e=>h.adminUpdateSettings(e,{finalListPublished:`false`}),getSettings:()=>m(`/admin/settings`),getPublicSettings:()=>m(`/admin/settings`),adminGetPosts:()=>m(`/admin/posts`),adminAddPost:(e,t)=>m(`/admin/posts`,{method:`POST`,body:JSON.stringify(t)}),adminUpdatePost:(e,t)=>m(`/admin/posts`,{method:`POST`,body:JSON.stringify(t)}),adminDeletePost:(e,t)=>m(`/admin/posts`,{method:`DELETE`,body:JSON.stringify({postName:t})}),getResults:()=>m(`/admin/results`),adminSaveResults:async(e,t)=>{let n=await m(`/admin/results`,{method:`POST`,body:JSON.stringify(t)});return p({action:`adminSaveResults`,results:t}),{ok:!0,res:n}},getPublicSchedule:()=>Promise.resolve({electionDate:n.ELECTION_DATE}),adminSaveSchedule:()=>Promise.resolve({ok:!0})};function g(e,t=n.ELECTION_DATE){if(!e)return`N/A`;let r=new Date(t),i=new Date(e),a=r.getFullYear()-i.getFullYear(),o=r.getMonth()-i.getMonth(),s=r.getDate()-i.getDate();return s<0&&(o--,s+=new Date(r.getFullYear(),r.getMonth(),0).getDate()),o<0&&(a--,o+=12),`${a} Years, ${o} Months, ${s} Days`}function _(e,t,n,r=null,i=[],a=[]){if(!e)return[];let o=[],s=String(e.CLASS||``).toUpperCase(),c=String(e.Dept||``).toUpperCase(),l=String(e[`Nominal Roll Serial Number`]),u=i.find(e=>e.post===t)||{};if((n===`Proposer`||n===`Seconder`)&&a.some(e=>e.post===t&&e.status!==`Rejected`&&(String(e.proposerSerial)===l||String(e.seconderSerial)===l))&&o.push(`Student #${l} has already proposed or seconded a candidate for "${t}". They cannot endorse multiple candidates for the same post.`),u.deptRestriction){let r=`Association Secretary `,i=t.startsWith(r)?t.replace(r,``).toUpperCase():null;i&&c!==i&&o.push(`${n} for "${t}" must be from the ${i} dept (current: ${e.Dept||`N/A`}).`)}let d=String(u.yearRestriction||``);return d===`1`&&!s.includes(`1ST YEAR`)&&o.push(`${n} must be a 1st Year student for this post.`),d===`2`&&!s.includes(`2ND YEAR`)&&o.push(`${n} must be a 2nd Year student for this post.`),d===`3`&&!s.includes(`3RD YEAR`)&&o.push(`${n} must be a 3rd Year student for this post.`),d===`PG`&&(s.includes(`MA`)||s.includes(`MSC`)||s.includes(`MCOM`)||s.includes(`M.SC`)||s.includes(`M.COM`)||s.includes(`M.A`)||o.push(`${n} for PG Representative must be a PG student (MA/MSc/MCom).`)),n===`Candidate`&&r&&(u.femaleOnly&&r===`Male`&&o.push(`The post of "${t}" is reserved for female candidates only.`),u.finalYearIneligible&&(s.includes(`3RD YEAR`)||s.includes(`2ND YEAR M`))&&o.push(`Final year students are not eligible for "${t}".`)),o}function v(){let e=Math.floor(Math.random()*10)+1,t=Math.floor(Math.random()*10)+1;return{question:`${e} + ${t}`,answer:String(e+t)}}function y(){return new Date().toLocaleDateString(`en-GB`)}function b(e,t,n){let r=[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`];for(let t=1;t<=31;t++)e.innerHTML+=`<option value="${t}">${t}</option>`;r.forEach((e,n)=>t.innerHTML+=`<option value="${n+1}">${e}</option>`);for(let e=2015;e>=1950;e--)n.innerHTML+=`<option value="${e}">${e}</option>`}function x(e,t,n){return`${n}-${String(t).padStart(2,`0`)}-${String(e).padStart(2,`0`)}`}function S(e,t,n){return`${String(e).padStart(2,`0`)}/${String(t).padStart(2,`0`)}/${n}`}function C(e,t=`Nomination Form`){let n=window.open(``,`_blank`);n.document.write(`
  ...
  `),n.document.close()}function w(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function T(e,t,n){t?(e.disabled=!0,e.innerHTML=`<span class="spinner"></span> Please wait...`):(e.disabled=!1,e.innerHTML=n)}function E(e,t=`info`){let n={info:`#6366f1`,success:`#10b981`,error:`#ef4444`,warning:`#f59e0b`},r=document.createElement(`div`);r.style.cssText=`position:fixed;bottom:1.5rem;right:1.5rem;z-index:9999;padding:0.75rem 1.25rem;border-radius:0.5rem;color:white;font-size:0.875rem;font-weight:500;background:${n[t]||n.info};box-shadow:0 10px 40px rgba(0,0,0,0.4);max-width:320px;transition:opacity 0.4s;`,r.textContent=e,document.body.appendChild(r),setTimeout(()=>{r.style.opacity=`0`,setTimeout(()=>r.remove(),400)},3500)}async function ee(e){e.innerHTML=`<div class="min-h-screen flex items-center justify-center"><span class="spinner"></span></div>`;let t=new Date().getFullYear(),n=`Government Victoria College, Palakkad`,r=`GVC`;try{let[e,i]=await Promise.all([h.getPublicSchedule(),h.getSettings().catch(()=>({}))]);e.electionYear&&(t=e.electionYear),i.electionYear&&(t=i.electionYear),i.collegeName&&(n=i.collegeName),i.collegeShortName&&(r=i.collegeShortName)}catch{}e.innerHTML=`
  ...
  </div>`}var O=[],k=[],te=[],A={},j=``;async function M(e){let t=new Date().getFullYear();try{let[e,n]=await Promise.all([h.getPublicSchedule(),h.getSettings().catch(()=>({}))]);e.electionYear&&(t=e.electionYear),n.electionYear&&(t=n.electionYear)}catch{}e.innerHTML=se(`Submit Nomination`,`
  ...
  `,t),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`));try{let[r,i,a,o]=await Promise.all([h.getNominalRoll(),h.getPosts().catch(()=>null),h.getPublicNominations().catch(()=>[]),h.getPublicSchedule().catch(()=>({}))]);if(O=Array.isArray(r)?r:[],te=Array.isArray(a)?a:[],A=o||{},O.length===0)throw Error(`Nominal roll is empty. Please contact the admin.`);k=Array.isArray(i)&&i.length>0?i:n.DEFAULT_POSTS,ne(e,t)}catch(t){e.querySelector(`#loadingState`).innerHTML=`
      <div class="alert alert-error">${w(t.message)}</div>
      <button class="btn btn-secondary mt-4" id="backBtn">← Back to Home</button>`,e.querySelector(`#backBtn`).addEventListener(`click`,()=>o.navigate(`/`))}}function ne(e,t){let n=v();j=n.answer,e.querySelector(`#loadingState`).classList.add(`hidden`);let r=e.querySelector(`#formArea`);r.classList.remove(`hidden`);let i=new Date,a=A.nominationDeadline?new Date(A.nominationDeadline):null;if(!window.ADMIN_BYPASS_PWD&&a&&i>a){r.innerHTML=`
    ...
    <form id="nomForm" class="space-y-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        ${N(`proposer`,`Proposer`,!1)}
        ${N(`seconder`,`Seconder`,!1)}
      </div>
  ...
  `,b(r.querySelector(`#dob-day`),r.querySelector(`#dob-month`),r.querySelector(`#dob-year`)),[`candidate`,`proposer`,`seconder`].forEach(e=>{r.querySelector(`#serial-${e}`).addEventListener(`change`,()=>re(r,e))}),r.querySelector(`#postSelect`).addEventListener(`change`,()=>P(r)),r.querySelectorAll(`[name="gender"]`).forEach(e=>e.addEventListener(`change`,()=>P(r))),r.querySelectorAll(`.dob-sel`).forEach(e=>e.addEventListener(`change`,()=>P(r))),r.querySelector(`#refreshCaptcha`).addEventListener(`click`,()=>{let e=v();j=e.answer,r.querySelector(`#captchaInput`).value=``,r.querySelector(`#captchaQuestion`).textContent=e.question}),r.querySelector(`#backHomeBtn`).addEventListener(`click`,()=>o.navigate(`/`)),r.querySelector(`#nomForm`).addEventListener(`submit`,e=>ie(e,r,t))}function N(e,t,n){return`
  ...
  </div>`}function re(e,t){let n=e.querySelector(`#serial-${t}`).value.trim(),r=e.querySelector(`#details-${t}`),i=O.find(e=>String(e[`Nominal Roll Serial Number`])===n);if(!i){r.innerHTML=n?`<span class="text-red-400">⚠ Student not found</span>`:``;return}r.innerHTML=`
    <p><span class="text-slate-500">Name:</span> <strong class="text-slate-200">${w(i.NAME)}</strong></p>
    <p><span class="text-slate-500">Class:</span> ${w(i.CLASS)}</p>
    <p><span class="text-slate-500">Dept:</span> ${w(i.Dept||`N/A`)}</p>`,P(e)}function P(e){let t=[],n=e.querySelector(`#postSelect`).value,r=e.querySelector(`[name="gender"]:checked`)?.value||null,i=[`candidate`,`proposer`,`seconder`].map(t=>e.querySelector(`#serial-${t}`).value.trim()),a=i.map(e=>e?O.find(t=>String(t[`Nominal Roll Serial Number`])===e):null),[o,s,c]=i;o&&o===s&&t.push(`Candidate and Proposer cannot be the same person.`),o&&o===c&&t.push(`Candidate and Seconder cannot be the same person.`),s&&s===c&&t.push(`Proposer and Seconder cannot be the same person.`);let l=[`Candidate`,`Proposer`,`Seconder`];a.forEach((e,i)=>{e&&t.push(..._(e,n,l[i],i===0?r:null,k,te))});let u=e.querySelector(`#warningBox`);return t.length?(u.innerHTML=`<strong class="block mb-1">⚠ Eligibility Warnings</strong>`+t.map(e=>`<p class="text-sm">• ${w(e)}</p>`).join(``),u.classList.remove(`hidden`)):u.classList.add(`hidden`),t}async function ie(e,t,n){if(e.preventDefault(),P(t).length){E(`Please resolve all eligibility warnings first.`,`error`);return}if(t.querySelector(`#captchaInput`).value.trim()!==j){E(`Captcha answer is incorrect.`,`error`);return}let r=t.querySelector(`#postSelect`).value,i=t.querySelector(`[name="gender"]:checked`)?.value,a=t.querySelector(`#dob-day`).value,o=t.querySelector(`#dob-month`).value,s=t.querySelector(`#dob-year`).value;if(!i){E(`Please select a gender for the candidate.`,`error`);return}if(!a||!o||!s){E(`Please enter a complete date of birth.`,`error`);return}let c=[`candidate`,`proposer`,`seconder`].map(e=>t.querySelector(`#serial-${e}`).value.trim()),l=c.map(e=>O.find(t=>String(t[`Nominal Roll Serial Number`])===e));if(l.some(e=>!e)){E(`One or more serial numbers are invalid.`,`error`);return}let u=t.querySelector(`#submitBtn`);T(u,!0,`Generate &amp; Preview Nomination`);try{let e={post:r,gender:i,dob:x(a,o,s),candidateSerial:c[0],proposerSerial:c[1],seconderSerial:c[2]};window.ADMIN_BYPASS_PWD&&(e.password=window.ADMIN_BYPASS_PWD);let u=await h.submitNomination(e);ae(t,u.id,{post:r,gender:i,day:a,month:o,year:s,students:l},n),E(`Nomination submitted! ID: ${u.id}`,`success`)}catch(e){E(`Submission failed: ${e.message}`,`error`)}finally{T(u,!1,`Generate &amp; Preview Nomination`)}}function ae(e,t,{post:n,gender:r,day:i,month:a,year:o,students:s},c){let[l,u,d]=s,f=x(i,a,o),p=S(i,a,o),m=g(f),h=e.querySelector(`#previewSection`);e.querySelector(`#printZone`).innerHTML=oe(t,n,r,p,m,l,u,d,``,c),h.classList.remove(`hidden`),h.scrollIntoView({behavior:`smooth`}),h.querySelector(`#printBtn`).addEventListener(`click`,()=>{C(e.querySelector(`#printZone`).innerHTML)}),h.querySelector(`#newNomBtn`).addEventListener(`click`,()=>M(e.closest(`#app`)))}function oe(e,t,r,i,a,o,s,c,l=``,u=`2026`){let d=y();return`
  ...
  <div class="glass rounded-lg p-4 text-sm space-y-1">
    ...
    <div class="grid grid-cols-2 gap-x-4 gap-y-1">
      <p><span class="text-slate-500">Name:</span> <strong class="text-slate-200">${w(t.NAME)}</strong></p>
      <p><span class="text-slate-500">Class:</span> ${w(t.CLASS)}</p>
      <p><span class="text-slate-500">Dept:</span> ${w(t.Dept||`N/A`)}</p>
      <p><span class="text-slate-500">Electoral Roll No:</span> ${w(t[`Nominal Roll Serial Number`])}</p>
  ...
  </div>`:``}function se(e,t,r=`2026`){return`
  ...
  </div>`}async function ce(e){e.innerHTML=ue(`Find My Nomination`,`
  ...
  <div class="page-enter min-h-screen">
    ...
    <main class="max-w-4xl mx-auto px-4 py-8">${t}</main>
  </div>`}async function de(e){e.innerHTML=pe(`Valid Nominations List`,`
  ...
  `),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`));try{let t=await h.getValidNominations();fe(e.querySelector(`main`),t)}catch(t){e.querySelector(`main`).innerHTML=`<div class="alert alert-warning text-center py-10 shadow-xl">${w(t.message)}</div>`}}function fe(e,t){if(!t||t.length===0){e.innerHTML=`
  ...
  </div>`}async function me(e){let t=new Date().getFullYear(),n=`GVC`;try{let[e,r]=await Promise.all([h.getPublicSchedule(),h.getSettings().catch(()=>({}))]);e.electionYear&&(t=e.electionYear),r.electionYear&&(t=r.electionYear),r.shortName&&(n=r.shortName)}catch{}e.innerHTML=ge(`Final Candidates List`,`
  ...
  `,t,n),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`));try{let n=await h.getFinalNominations();he(e.querySelector(`main`),n.active||[],t)}catch(t){e.querySelector(`main`).innerHTML=`<div class="alert alert-warning text-center py-10 shadow-xl">${w(t.message)}</div>`}}function he(e,t,n){if(!t||t.length===0){e.innerHTML=`
      <div class="glass rounded-3xl p-20 text-center border-dashed border-white/10">
        <div class="text-6xl mb-6">🏁</div>
    ...
    </div>`}function ge(e,t,n=`2026`,r=`GVC`){return`
  <div class="page-enter min-h-screen">
    <header class="no-print sticky top-0 z-10 border-b border-white/10 glass">
      <div class="max-w-5xl mx-auto px-6 py-3 flex items-center justify-between">
        <div class="flex items-center gap-4">
    ...
    <main class="max-w-5xl mx-auto px-4 py-12">${t}</main>
  </div>`}async function _e(e){e.innerHTML=be(`Withdrawal Form`,`
    <div id="loadingState" class="flex flex-col items-center justify-center py-24 gap-4">
      <span class="spinner" style="width:2.5rem;height:2.5rem;border-width:4px;"></span>
      <p class="text-slate-400 text-sm">Checking schedule...</p>
    </div>
    <div id="withdrawArea" class="hidden"></div>
  `),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`));try{let t=await h.getPublicSchedule().catch(()=>({})),n=new Date,r=t.withdrawalStart?new Date(t.withdrawalStart):null,i=t.withdrawalEnd?new Date(t.withdrawalEnd):null,a=e.querySelector(`#withdrawArea`);if(e.querySelector(`#loadingState`).classList.add(`hidden`),a.classList.remove(`hidden`),r&&n<r){a.innerHTML=`
    ...
    <div class="space-y-4">
      ...
      <div class="flex gap-3">
    ...
    </div>`,e.querySelector(`#withdrawBtn`).addEventListener(`click`,async()=>{let r=e.querySelector(`#withdrawBtn`);T(r,!0,`Submit Withdrawal Request`);try{await h.submitWithdrawal(n),e.innerHTML=`
        ...
        <div class="print-zone mt-4">
          ${ye(n,t)}
        </div>`,e.querySelector(`#printWithdrawal`).addEventListener(`click`,C),E(`Withdrawal request submitted!`,`success`)}catch(e){E(`Failed: ${e.message}`,`error`),T(r,!1,`Submit Withdrawal Request`)}})}function ye(e,t){let r=y(),i=t.candidate?.NAME||t.candidateName||`N/A`,a=t.candidate?.CLASS||t.candidateClass||`N/A`,o=t.candidate?.Dept||t.candidateDept||`N/A`;return`
  ...
  </div>`,e.querySelectorAll(`[data-admin-nav]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.adminNav;if(t===`public`){o.navigate(`/`);return}o.navigate(`/admin/${t}`)})}),e.querySelector(`#logoutBtn`).addEventListener(`click`,()=>{localStorage.removeItem(`adminPwd`),localStorage.removeItem(`adminLoginDate`),localStorage.removeItem(`adminSessionToken`),sessionStorage.removeItem(`adminSessionToken`),E(`Logged out.`,`info`),o.navigate(`/`)})}function B(e,t,n,r){return`
  <button data-admin-nav="${e}" class="sidebar-item ${r===e?`active`:``}">
    <span>${t}</span> ${n}
  </button>`}async function we(e){let t=R();if(t){z(e,`dashboard`,`
  ...
  `);try{let[n,i]=await Promise.all([h.adminGetNominations(t),h.adminGetSettings(t)]),a=n.length,o=n.filter(e=>e.status===`Pending`).length,s=n.filter(e=>e.status===`Valid`).length,c=n.filter(e=>e.status===`Rejected`).length,l=n.filter(e=>e.withdrawalStatus===`Requested`).length,u=e.querySelector(`#adminMain`);u.innerHTML=`
  ...
  </div>`}async function Te(e){let t=R();if(t){z(e,`verify`,`
  ...
  `);try{let n=await h.adminGetNominations(t);Ee(e.querySelector(`#adminMain`),n,t)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${w(t.message)}</div>`}}}function Ee(e,t,n){e.innerHTML=`
  ...
  `);try{let n=await h.adminGetNominations(t);Oe(e.querySelector(`#adminMain`),n,t)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${w(t.message)}</div>`}}}function Oe(e,t,n){let r=Array.isArray(t)?t:[],i=r.filter(e=>e.withdrawalStatus&&e.withdrawalStatus!==`None`),a=r.filter(e=>e.status===`Valid`&&e.withdrawalStatus!==`Approved`);e.innerHTML=`
    <div class="page-enter space-y-4">
      <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-2">
        <div>
      ...
      </tr>`).join(``):`<tr><td colspan="6" class="text-center text-slate-500 py-12">No valid nominations available for withdrawal.</td></tr>`},g=()=>{let t=e.querySelector(`#directSearch`).value.toLowerCase();m(p.filter(e=>!t||String(e.id).toLowerCase().includes(t)||String(e.candidateName||``).toLowerCase().includes(t)||String(e.post).toLowerCase().includes(t)))};e.querySelector(`#directSearch`).addEventListener(`input`,g),m(p),e.querySelector(`#panelDirect`).addEventListener(`click`,async e=>{let t=e.target.closest(`.direct-withdraw-btn`);if(!t)return;let r=t.dataset.id,i=p.find(e=>e.id===r);if(confirm(`CONFIRM DIRECT WITHDRAWAL\n\nCandidate: ${i?.candidateName||r}\nPost: ${i?.post||``}\n\nThis will immediately mark this nomination as Withdrawn. This cannot be undone. Proceed?`)){t.disabled=!0,t.innerHTML=`<span class="spinner" style="width:1rem;height:1rem;border-width:2px;"></span>`;try{await h.adminDirectWithdrawal(n,r),E(`Nomination ${r} directly withdrawn.`,`success`),p=p.filter(e=>e.id!==r),g()}catch(e){E(`Failed: ${e.message}`,`error`),t.disabled=!1,t.innerHTML=`⚡ Withdraw Now`}}})}async function ke(e){let t=R();if(t){z(e,`publish`,`
  ...
  `);try{let[n,r,i]=await Promise.all([h.adminGetSettings(t),h.adminGetNominations(t),h.getPosts()]);H(e.querySelector(`#adminMain`),n,r,i,t)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${w(t.message)}</div>`}}}function H(e,t,r,i,a){let o=t.validListPublished===`true`,s=t.finalListPublished===`true`;e.innerHTML=`
...
This will remove the final candidate list from public view.`)){T(n,!0,`🚫 Unpublish`);try{await h.adminUnpublishFinalList(a),E(`Final list unpublished.`,`success`),H(e,{validListPublished:`true`,finalListPublished:`false`},r,i,a)}catch(e){E(`Failed: ${e.message}`,`error`),T(n,!1,`🚫 Unpublish`)}}})}async function Ae(e){let t=R();if(t){z(e,`posts`,`
  ...
  `);try{let r=await h.adminGetPosts(t).catch(()=>null);(!Array.isArray(r)||r.length===0)&&(r=n.DEFAULT_POSTS),je(e.querySelector(`#adminMain`),r,t)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${w(t.message)}</div>`}}}function je(e,t,n){e.innerHTML=`
    ...
    </div>`,U(e,t,n),Me(e,t,n)}function U(e,t,n){let r=e.querySelector(`#postsBody`);r.innerHTML=t.length?t.map((e,t)=>`
    <tr id="post-row-${t}">
      <td class="text-slate-500 text-xs">${t+1}</td>
      <td class="font-medium text-white">${w(e.post)}</td>
  ...
  `);try{let[n,r,i,a,o,s,c]=await Promise.all([h.getNominalRoll(),h.adminGetBooths(t).catch(()=>[]),h.adminGetLocations(t).catch(()=>[]),h.adminGetPosts(t).catch(()=>[]),h.getFinalNominations().catch(()=>({active:[]})),h.adminGetBallotPlan(t).catch(()=>null),h.adminGetSettings(t).catch(()=>({}))]);Pe(e.querySelector(`#adminMain`),t,n,r,i,a,o,s,c)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${w(t.message)}</div>`}}}function Pe(e,t,r,i,a,o,s,c,l){let u={};r.forEach(e=>{let t=String(e.CLASS||`Unknown`).trim(),n=String(e.Dept||`Unknown`).trim();u[t]||(u[t]={name:t,dept:n,count:0}),u[t].count++});let d=Object.values(u).sort((e,t)=>e.name.localeCompare(t.name)),f=i.length?[...i]:[{boothNumber:1,roomName:``,classes:[]}],p=[...a],m=!0,g=()=>{f.forEach(e=>e.totalStudents=0);let n=[];d.forEach(e=>{let t=f.find(t=>t.classes.includes(e.name));t?t.totalStudents+=e.count:n.push(e)});let i=window.scrollY;e.innerHTML=`
        <!-- Locations Modal -->
    ...
    `,m||window.scrollTo(0,i),m=!1,e.querySelector(`#btnClearAll`).addEventListener(`click`,()=>{confirm(`Clear all class allotments? Room locations will be kept.`)&&(f.forEach(e=>e.classes=[]),g())}),e.querySelector(`#btnPrintRolls`).addEventListener(`click`,()=>{let t=e.querySelector(`#printArea`);t.innerHTML=_(f,r,o,u,s,c);let n=window.open(``,`_blank`);n.document.write(`
        <html>
          <head>
      ...
      `),n.document.close(),n.focus(),setTimeout(()=>{n.print()},500)}),e.querySelector(`#btnUpdateBoothCount`).addEventListener(`click`,()=>{let t=parseInt(e.querySelector(`#numBoothsInput`).value,10);if(t>0&&t<=50){if(t>f.length)for(let e=f.length;e<t;e++)f.push({boothNumber:e+1,roomName:``,classes:[]});else t<f.length&&(f=f.slice(0,t));g()}}),e.querySelectorAll(`.room-name-select`).forEach(e=>{e.addEventListener(`change`,e=>{f[e.target.dataset.idx].roomName=e.target.value,g()})});let a=e.querySelector(`#locationsModal`),l=()=>a.classList.add(`hidden`),b=()=>a.classList.remove(`hidden`),x=()=>{let e=a.querySelector(`#locationsList`);e.innerHTML=p.length?p.map((e,t)=>`
        <span class="badge badge-valid bg-white/10 text-white border border-white/20 px-3 py-1 flex items-center gap-2">
          ${w(e)}
          <button class="text-red-400 hover:text-red-300 font-bold delete-location" data-idx="${t}">&times;</button>
        </span>
      `).join(``):`<span class="text-slate-500 text-sm">No locations added yet.</span>`,e.querySelectorAll(`.delete-location`).forEach(e=>{e.addEventListener(`click`,e=>{let t=parseInt(e.target.dataset.idx),n=p[t];p.splice(t,1),f.forEach(e=>{e.roomName===n&&(e.roomName=``)}),x()})})};e.querySelector(`#btnManageLocations`).addEventListener(`click`,b),e.querySelector(`#btnCloseLocationsModal`).addEventListener(`click`,l),e.querySelector(`#btnCloseLocationsModal2`).addEventListener(`click`,l),e.querySelector(`#locationsModalOverlay`).addEventListener(`click`,l),e.querySelector(`#btnAddLocation`).addEventListener(`click`,()=>{let t=e.querySelector(`#newLocationInput`).value.trim();t&&!p.includes(t)&&(p.push(t),e.querySelector(`#newLocationInput`).value=``,x())}),e.querySelector(`#newLocationInput`).addEventListener(`keydown`,t=>{t.key===`Enter`&&e.querySelector(`#btnAddLocation`).click()}),x(),e.querySelector(`#btnSaveLocations`).addEventListener(`click`,async e=>{let n=e.target;T(n,!0,`💾 Save Locations`);try{await h.adminSaveLocations(t,p),E(`Locations saved! Refresh booths to see updated room list.`,`success`),l(),g()}catch(e){E(`Failed to save: ${e.message}`,`error`)}finally{T(n,!1,`💾 Save Locations`)}}),e.querySelectorAll(`.class-booth-select`).forEach(e=>{e.addEventListener(`change`,e=>{let t=e.target.dataset.class,n=e.target.value;f.forEach(e=>{e.classes=e.classes.filter(e=>e!==t)}),n!==``&&f[parseInt(n,10)].classes.push(t),g()})}),e.querySelector(`#btnSaveBooths`).addEventListener(`click`,async e=>{let n=e.target;T(n,!0,`💾 Save Configuration`);try{await h.adminSaveBooths(t,f),E(`Booth configuration saved successfully!`,`success`)}catch(e){E(`Failed to save: ${e.message}`,`error`)}finally{T(n,!1,`💾 Save Configuration`)}}),e.querySelector(`#btnRegenPlan`).addEventListener(`click`,async e=>{let n=e.target,r=`🔄 Finalize Master Plan`;try{T(n,!0,r),E(`Calculating and saving Master Plan on server...`,`info`),await h.adminGenerateBallotPlan(t),E(`Master Plan finalized successfully! You can now print documents.`,`success`),c=await h.adminGetBallotPlan(t).catch(()=>null)}catch(e){E(e.message,`error`)}finally{T(n,!1,r)}}),e.querySelector(`#btnAutoAllot`).addEventListener(`click`,()=>{y(),g(),E(`Auto allotment complete. Please review and save.`,`info`)})},_=(e,t,r,i,a,o)=>{let s=l?.collegeName||n.COLLEGE_NAME||`COLLEGE UNION ELECTION`,c=``;return o?([...e].sort((e,t)=>e.boothNumber-t.boothNumber).forEach(e=>{if(!e.classes||e.classes.length===0)return;let n=t.filter(t=>e.classes.includes(String(t.CLASS).trim())).length,r=e.classes.map(e=>i[e]).filter(Boolean),a=o.boothAssignments[e.boothNumber]||{general:null,reps:[],assocs:[]};c+=`
  ...
  `);try{let[n,r,i,a,o]=await Promise.all([h.adminGetCountingMatrix(t).catch(()=>null),h.getPosts(),h.adminGetNominations(t).catch(()=>[]),h.adminGetBooths(t),h.getNominalRoll()]),s=(Array.isArray(i)?i:[]).filter(e=>e.status===`Valid`&&e.withdrawalStatus!==`Approved`);Ie(e.querySelector(`#adminMain`),t,n,r,s,a,o)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${w(t.message)}</div>`}}}function Ie(e,t,n,r,i,a,o){if(!a.length){e.innerHTML=`<div class="alert alert-error">❌ No booths configured.</div>`;return}if(!r.length){e.innerHTML=`<div class="alert alert-error">❌ No posts configured.</div>`;return}let s=e=>String(e.post||e.name||``),c=t=>{let{matrix:n,formSerials:o,totalRounds:c,roundLabels:u}=t,d=a.length;e.innerHTML=`
      <div class="page-enter space-y-6">
      ...
      </style></head><body>${e}<script>window.onload=()=>setTimeout(()=>window.print(),400)<\/script></body></html>`),r.document.close()})},l=async()=>{let n=a.length,i=e=>{let t=s(e);return t.toUpperCase().startsWith(`ASSOCIATION SECRETARY `)?t.substring(22).toUpperCase().trim():null},l={};o.forEach(e=>{let t=String(e.CLASS||``).trim(),n=String(e.Dept||``).trim().toUpperCase();t&&n&&(l[t]=n)});let u=a.map(e=>new Set((e.classes||[]).map(e=>l[e]||``).filter(Boolean))),d=a.map(e=>{let t=new Set;return(e.classes||[]).forEach(e=>{let n=e.toUpperCase();[`MA`,`MSC`,`MCOM`,`M.SC`,`M.COM`,`M.A`].some(e=>n.includes(e))?t.add(`PG`):(n.includes(`1ST YEAR`)&&t.add(`1`),n.includes(`2ND YEAR`)&&t.add(`2`),n.includes(`3RD YEAR`)&&t.add(`3`))}),t}),f=r.filter(e=>{let t=s(e).toUpperCase();return t.includes(`UUC`)||t.includes(`UNIVERSITY UNION COUNCILLOR`)}),p=r.filter(e=>!f.includes(e)&&s(e).toUpperCase().includes(`ASSOCIATION`)),m=r.filter(e=>!f.includes(e)&&!p.includes(e)&&e.yearRestriction&&String(e.yearRestriction).trim()!==``),g=r.filter(e=>!f.includes(e)&&!p.includes(e)&&!m.includes(e)),_=g.length,v=Array.from({length:n},(e,t)=>{let n=[];p.forEach(e=>{let r=i(e);r&&u[t].has(r)&&n.push(e)}),m.forEach(e=>{d[t].has(String(e.yearRestriction))&&n.push(e)});for(let e=0;e<_;e++)n.push(g[(t+e)%_]);return f.forEach(e=>n.push(e)),n}),y=Math.max(...v.map(e=>e.length),0);v.forEach(e=>{for(;e.length<y;)e.push(null)});let b={},x=1;for(let e=0;e<y;e++)for(let t=0;t<n;t++)v[t][e]&&(b[`${t}-${e}`]=x++);let S=[];for(let e=0;e<y;e++)S.push(`Round ${e+1}`);let C={matrix:v,formSerials:b,totalRounds:y,roundLabels:S};try{e.innerHTML=`<div class="text-center py-20"><span class="spinner"></span><p class="mt-4 text-slate-400">Saving Matrix...</p></div>`,await h.adminSaveCountingMatrix(t,C),E(`Counting Matrix saved successfully!`,`success`),c(C)}catch(e){E(`Error saving matrix: `+e.message,`error`),c(C)}};n?c(n):(e.innerHTML=`
    ...
    `,e.querySelector(`#btnInitialGenerate`).addEventListener(`click`,l))}function Le(e,t,n,r,i){let a=r.length?r.map((e,t)=>`<tr>
  ...
  </div>`}var W=[],G=!1,Re=null;window.addEventListener(`beforeunload`,e=>{W.some(e=>e.status===`pending`||e.status===`syncing`||e.status===`retry`)&&(e.preventDefault(),e.returnValue=`You have unsaved forms syncing in the background. Are you sure you want to leave?`)});function K(e){W.forEach(t=>{t.payload&&t.payload.forEach(t=>{let n=e.findIndex(e=>String(e.TableNumber)===String(t.TableNumber)&&String(e.Post)===t.Post&&e.CandidateId===t.CandidateId);n>=0?(e[n].Votes=t.Votes,e[n].RoundNumber=t.RoundNumber,e[n].FormSerial=t.FormSerial):e.push({...t})})})}async function ze(e){let t=R();if(t){z(e,`results-entry`,`
    <div class="text-center py-16"><span class="spinner" style="width:2.5rem;height:2.5rem;border-width:4px;"></span><p class="text-slate-400 mt-4 text-sm">Loading data...</p></div>
  `);try{let[n,r,i,a,o]=await Promise.all([h.adminGetBooths(t).catch(()=>[]),h.getPosts(),h.adminGetNominations(t).catch(()=>[]),h.getResults().catch(()=>[]),h.adminGetCountingMatrix(t).catch(()=>null)]),s=(Array.isArray(i)?i:[]).filter(e=>e.status===`Valid`&&e.withdrawalStatus!==`Approved`);Be(e.querySelector(`#adminMain`),t,n,r,s,a,o)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${w(t.message)}</div>`}}}function Be(e,t,n,r,i,a,o){let s=e=>String(e.post||e.name||``);if(!o){e.innerHTML=`
  ...
  `;let f=e.querySelector(`#txtSerial`),p=e.querySelector(`#btnLoadBySerial`),m=async()=>{let e=f.value.trim();if(!e)return;let t=u[e];if(!t){E(`Invalid Serial Number: ${e}`,`error`);return}try{T(p,!0,`Loading...`),h.invalidateCache(`getResults`);let r=await h.getResults().catch(()=>[]);a.length=0,a.push(...r),K(a),g(n[t.t].boothNumber,t.postName,e,t.r+1)}catch{K(a),g(n[t.t].boothNumber,t.postName,e,t.r+1)}finally{T(p,!1,`Load Form`)}};p.addEventListener(`click`,m),f.addEventListener(`keypress`,e=>{e.key===`Enter`&&m()}),e.querySelector(`#btnLoadForm`).addEventListener(`click`,async()=>{let t=e.querySelector(`#selTable`).value,r=e.querySelector(`#selPost`).value;if(!t||!r){E(`Select Table and Post`,`warning`);return}let i=n.findIndex(e=>String(e.boothNumber)===String(t)),o=null,u=null;if(i>=0){for(let e=0;e<c[i].length;e++)if(s(c[i][e])===r){u=e+1,o=l[`${i}-${e}`];break}}try{T(e.querySelector(`#btnLoadForm`),!0,`...`),h.invalidateCache(`getResults`);let n=await h.getResults().catch(()=>[]);a.length=0,a.push(...n),K(a),g(t,r,o,u)}catch{K(a),g(t,r,o,u)}finally{T(e.querySelector(`#btnLoadForm`),!1,`Load`)}});let g=(n,r,o,s)=>{let c=e.querySelector(`#entryFormArea`),l=i.filter(e=>e.post===r);if(l.length===0){c.innerHTML=`<div class="alert alert-warning">No candidates found for ${w(r)}.</div>`;return}let u=a.filter(e=>String(e.TableNumber)===String(n)&&String(e.Post)===r),p=e=>u.find(t=>t.CandidateId===e)?.Votes||``;c.innerHTML=`
        ...
        <div class="p-6 space-y-4">
          ${l.map((e,t)=>`
            <div class="flex items-center justify-between bg-white/5 p-4 rounded-lg border border-white/5">
              ...
              <div class="w-32">
                <input type="number" class="field text-center text-lg font-bold vote-input" data-cid="${w(e.id)}" data-cname="${w(e.candidateName)}" placeholder="0" value="${p(e.id)}" min="0">
              </div>
            </div>
          `).join(``)}
  ...
  `;let i=e=>{let t=window.open(``,`_blank`);t.document.write(`
    ...
    `),t.document.close()},a=async(e=`all`)=>{let r,i,a,o;try{[r,i,a,o]=await Promise.all([h.adminGetPosts(t),h.getFinalNominations(),h.getPublicSchedule(),h.adminGetSettings(t).catch(()=>({}))])}catch(e){throw Error(e.message.includes(`not published`)?`Final List Not Published. Please finalize and publish the list first.`:e.message)}let s=o.collegeName||n.COLLEGE_NAME,c=o.collegeShortName||n.COLLEGE_SHORT_NAME,l=a.electionYear||new Date().getFullYear().toString(),u=i.active||[];if(u.length===0)throw Error(`No active candidates found.`);let d=e=>{let t=e.post.toLowerCase();return t.includes(`representative`)||t.includes(`year`)},f=e=>{let t=e.post.toLowerCase();return t.includes(`association`)||t.includes(`assoc`)},p=e=>!d(e)&&!f(e),m=r.filter(e=>u.filter(t=>t.post===e.post).length>1),g=``;if(e===`all`||e===`general`){let e=m.filter(p);if(e.length>0){g+=`
        ...
        `;let t=[...e].sort((e,t)=>{let n=e.post.toLowerCase(),r=t.post.toLowerCase();return n.includes(`chairman`)&&!n.includes(`vice`)?-1:r.includes(`chairman`)&&!r.includes(`vice`)?1:n.includes(`vice chairman`)?-1:r.includes(`vice chairman`)||n.includes(`university union councillor`)||n.includes(`uuc`)?1:r.includes(`university union councillor`)||r.includes(`uuc`)?-1:0}),n=``,r=``;t.forEach((e,t)=>{let i=u.filter(t=>t.post===e.post),a=`
          ...
          `;t%2==0?n+=a:r+=a}),g=g.replace(`<div class="ballot-col" id="col1"></div>`,`<div class="ballot-col" id="col1">${n}</div>`),g=g.replace(`<div class="ballot-col" id="col2"></div>`,`<div class="ballot-col" id="col2">${r}</div>`)}}let _=m.filter(e=>d(e)||f(e));return(e===`all`||e===`year`||e===`assoc`)&&_.filter(t=>e===`all`||e===`year`&&d(t)||e===`assoc`&&f(t)).forEach(e=>{let t=u.filter(t=>t.post===e.post),n=d(e)?`R`:`A`;g+=`
        ...
        `}),g},o=async e=>{try{E(`Generating ballots...`,`info`),i(await a(e))}catch(e){E(e.message,`error`)}},s=async()=>{try{E(`Calculating Master Plan...`,`info`);let[e,r,a]=await Promise.all([h.getPublicSchedule(),h.adminGetSettings(t).catch(()=>({})),h.adminGetBallotPlan(t).catch(()=>null)]);if(!a)return confirm(`No Master Plan found. Generate it now based on current final list and booths?`)?(await c(),s()):void 0;let o=a,l=e.electionYear||new Date().getFullYear(),u=r.collegeName||`Government Victoria College Palakkad`,d=e=>!e||Array.isArray(e)&&e.length===0?`-`:typeof e==`string`?e:`
      ...
      `)}catch(e){E(e.message,`error`)}},c=async e=>{let n=e?.target,r=`🔄 Finalize Master Plan`;try{n&&T(n,!0,r),E(`Calculating and saving Master Plan on server...`,`info`),await h.adminGenerateBallotPlan(t),E(`Master Plan finalized successfully!`,`success`),n&&T(n,!1,r)}catch(e){n&&T(n,!1,r),E(e.message,`error`)}};r.querySelector(`#btnGenSummary`).onclick=s,r.querySelectorAll(`.preview-btn`).forEach(e=>{e.onclick=()=>o(e.dataset.type)})}function He(e){let t=R();if(!t)return;z(e,`testing`,`
...
Proceed?`))return;T(r,!0,`🧪 Inject Test Nominations`);let i=n.querySelector(`#injectStatus`);i.innerHTML=``;try{let e=await h.adminInjectTestData(t),n=e.skipped>0?`<br><span class="text-amber-400 text-xs mt-1 block">⚠️ ${e.skipped} post(s) skipped — not enough eligible students in NominalRoll: <em>${e.skippedPosts.join(`, `)}</em></span>`:``;i.innerHTML=`
...
Are you absolutely sure?`))return;T(t,!0,`🗑️ Wiping...`);let i=n.querySelector(`#wipeStatus`);i.innerHTML=``;try{await h.adminWipeData(r),n.querySelector(`#wipePasswordInput`).value=``,i.innerHTML=`
        ...
        </div>`,E(`All data wiped successfully.`,`success`)}catch(e){i.innerHTML=`<div class="alert alert-error mt-3">❌ ${w(e.message)}</div>`,E(`Failed: ${e.message}`,`error`)}finally{T(t,!1,`🗑️ Permanently Wipe All Data`)}})}async function Ue(e){let t=R();if(t){z(e,`results`,`
  ...
  `,e.querySelector(`#btnPrintOfficial`).addEventListener(`click`,()=>{let e=`
    ...
    `),t.document.close()})}var Ge=`election_results_cache`,Y=`election_results_last_fetch`,Ke=300*1e3;async function qe(e){e.innerHTML=`
    <div class="page-enter min-h-screen">
      <header class="no-print sticky top-0 z-10 border-b border-white/10 glass">
        <div class="max-w-5xl mx-auto px-6 py-3 flex items-center justify-between">
          <div class="flex items-center gap-4">
  ...
  `;let t=e.querySelector(`#cacheTimer`),n=e.querySelector(`#btnRefresh`),r=()=>{let e=localStorage.getItem(Y);if(!e){t.textContent=``,n.disabled=!1,n.classList.remove(`opacity-50`,`cursor-not-allowed`);return}let r=parseInt(e,10)+Ke,i=Math.max(0,r-Date.now());i<=0?(t.textContent=`Live Update Available`,t.classList.add(`text-green-400`),n.disabled=!1,n.classList.remove(`opacity-50`,`cursor-not-allowed`,`pointer-events-none`)):(t.textContent=`Update in ${Math.floor(i/6e4)}:${Math.floor(i%6e4/1e3).toString().padStart(2,`0`)}`,t.classList.remove(`text-green-400`),n.disabled=!0,n.classList.add(`opacity-50`,`cursor-not-allowed`,`pointer-events-none`))};setInterval(r,1e3),r(),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`)),n.addEventListener(`click`,t=>{if(n.disabled||n.classList.contains(`pointer-events-none`)){t.preventDefault();return}X(e.querySelector(`#resultsMain`),!0)}),await X(e.querySelector(`#resultsMain`))}async function X(e,t=!1){try{let n=localStorage.getItem(Y),r=localStorage.getItem(Ge),i,a;if(!t&&n&&r&&Date.now()-parseInt(n,10)<Ke){let t=JSON.parse(r);i=t.posts,a=t.results,o(e,(t.schedule||{}).electionYear||new Date().getFullYear())}else{e.innerHTML=`
      ...
      `:e.innerHTML=c}catch(t){e.innerHTML=`<div class="alert alert-error">❌ Failed to load results: ${w(t.message)}</div>`}}async function Je(e){e.innerHTML=`
  ...
  `;try{let[t,n]=await Promise.all([h.getNominalRoll(),h.getSettings()]);Ye(e,t,n)}catch(t){e.innerHTML=`<div class="alert alert-error">❌ ${w(t.message)}</div>`}}function Ye(e,t,n){let r=n.nominalRollFinalized===`true`,i=[...t],a=``,o=()=>{let t=i.filter(e=>[e.NAME,e.CLASS,e[`ADMISION NO`],e[`Nominal Roll Serial Number`]].some(e=>String(e||``).toLowerCase().includes(a.toLowerCase())));e.innerHTML=`
      <div class="page-enter space-y-6">
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
    ...
    `;let n=e.querySelector(`.dropdown-toggle`),s=e.querySelector(`.dropdown-menu`);n&&(n.onclick=e=>{e.stopPropagation(),s.classList.toggle(`hidden`)}),window.onclick=()=>s?.classList.add(`hidden`),e.querySelector(`#searchInput`).oninput=t=>{a=t.target.value,o();let n=e.querySelector(`#searchInput`);n.focus();let r=n.value;n.value=``,n.value=r},e.querySelector(`#btnPrintSerial`).onclick=()=>Xe(i,r,`serial`),e.querySelector(`#btnPrintClass`).onclick=()=>Xe(i,r,`class`)};o()}function Xe(e,t,r){let i=[...e];r===`class`?i.sort((e,t)=>{let n=String(e.CLASS).toUpperCase(),r=String(t.CLASS).toUpperCase();return n===r?String(e.NAME).toUpperCase().localeCompare(String(t.NAME).toUpperCase()):n.localeCompare(r)}):i.sort((e,t)=>Number(e[`Nominal Roll Serial Number`])-Number(t[`Nominal Roll Serial Number`]));let a=n.COLLEGE_NAME||`GOVERNMENT VICTORIA COLLEGE, PALAKKAD`,o=t?`FINAL NOMINAL ROLL`:`DRAFT NOMINAL ROLL`,s=new Date().toLocaleString(),c=window.open(``,`_blank`);c.document.write(`
    <html>
      <head>
        <title>${o}</title>
        <style>
  ...
  `),c.document.close()}async function Z(e){let t=R();if(t){z(e,`nominalRoll`,`
    <div class="text-center py-16"><span class="spinner" style="width:2.5rem;height:2.5rem;border-width:4px;"></span><p class="text-slate-400 mt-4 text-sm">Loading nominal roll...</p></div>
  `);try{let[n,r]=await Promise.all([h.getNominalRoll(),h.getSettings()]);Ze(e.querySelector(`#adminMain`),t,n,r)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${w(t.message)}</div>`}}}function Ze(e,t,n,r){let i=r.nominalRollFinalized===`true`,a=[...n],o=``,s=[...new Set(n.map(e=>String(e.CLASS).trim()))].sort(),c=[...new Set(n.map(e=>String(e.Dept||`–`).trim()))].sort(),l=()=>{let n=a.filter(e=>[e.NAME,e.CLASS,e[`ADMISION NO`],e[`Nominal Roll Serial Number`]].some(e=>String(e||``).toLowerCase().includes(o.toLowerCase())));e.innerHTML=`
      <div class="page-enter space-y-6">
...
Are you absolutely sure?`)){T(n.target,!0,`Finalizing...`);try{await h.adminFinalizeRoll(t),E(`Nominal Roll Finalized Successfully!`,`success`),Z(e.closest(`#appContainer`)||e.parentElement)}catch(e){E(e.message,`error`),T(n.target,!1,`Finalize & Lock Roll`)}}}),e.querySelector(`#btnPrintRoll`).onclick=()=>Qe(a,i,r.collegeName),e.querySelector(`#toggleUploadPanel`).onclick=()=>{let t=e.querySelector(`#uploadPanelBody`),n=e.querySelector(`#uploadChevron`);t.classList.toggle(`hidden`),n.style.transform=t.classList.contains(`hidden`)?``:`rotate(180deg)`},e.querySelector(`#btnDownloadTemplate`).onclick=async e=>{let n=e.currentTarget;T(n,!0,`Downloading...`);try{let e=await h.adminGetNominalRollTemplate(t),n=[e.headers.join(`,`)];e.rows.forEach(e=>{n.push(e.map(e=>{let t=String(e??``);return t.includes(`,`)||t.includes(`"`)?`"${t.replace(/"/g,`""`)}"`:t}).join(`,`))});let r=new Blob([n.join(`\r
...
`).filter(e=>e.trim());if(n.length<2){E(`CSV file appears empty.`,`error`);return}let r=-1;for(let e=0;e<Math.min(n.length,20);e++){let t=n[e].split(`,`).map(e=>e.trim().replace(/^"|"$/g,``));if(f.every(e=>t.includes(e))){r=e,d=f;break}if(p.every(e=>t.includes(e))){r=e,d=p;break}}if(r===-1){E(`Missing required columns. Please use one of the standard templates.`,`error`),e.querySelector(`#csvPreview`).classList.add(`hidden`);return}let i=n[r].split(`,`).map(e=>e.trim().replace(/^"|"$/g,``)),a=d.map(e=>i.indexOf(e));u=n.slice(r+1).map(e=>{let t=[],n=``,r=!1;for(let i of e+`,`)i===`"`?r=!r:i===`,`&&!r?(t.push(n.trim()),n=``):n+=i;return a.map(e=>t[e]??``)}).filter(e=>e[1]&&e[1].trim()!==``&&e[1]!==`NAME`),d.indexOf(`NAME`);let o=d.indexOf(`Dept`),s=[];s=d===f?[...new Set(u.map(e=>e[d.indexOf(`CLASS`)]))].sort():[...new Set(u.map(e=>`${e[d.indexOf(`YEAR`)]} ${e[d.indexOf(`STREAM`)]} ${e[o]}`.trim()))].sort();let c=[...new Set(u.map(e=>e[o]))].sort();e.querySelector(`#csvSummary`).innerHTML=`
  ...
  `),f.document.close()}async function $e(e){let t=R();if(t){z(e,`schedule`,`
  ...
  `);try{let n=await h.getPublicSchedule();et(e.querySelector(`#adminMain`),t,n)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${w(t.message)}</div>`}}}function et(e,t,n){let r=e=>e?new Date(e).toISOString().slice(0,16):``;e.innerHTML=`
  ...
  `),await M(e.querySelector(`#nominationWrapper`)))}async function nt(e){let t=R();if(!t)return;z(e,`audit`,`
    <div class="page-enter space-y-8">
      <div class="flex items-end justify-between">
        <div>
  ...
  `);let n=e.querySelector(`#btnRunAudit`),r=e.querySelector(`#auditResults`);n.addEventListener(`click`,async()=>{n.disabled=!0,n.innerHTML=`<span class="spinner w-4 h-4 mr-2 border-2"></span> Running Audit...`,r.innerHTML=`
    ...
    `;try{let e=(await h.adminRunAudit(t)).report,n=(e,t)=>t.pass?`
      ...
      `,e.rollCheck.pass&&e.serialCheck.pass&&e.resultsCheck.pass&&e.formsCheck.pass?r.innerHTML=`
         ...
         `+r.innerHTML,E(`Audit completed.`,`info`)}catch(e){r.innerHTML=`<div class="alert alert-error">❌ Audit failed: ${w(e.message)}</div>`,E(e.message,`error`)}finally{n.disabled=!1,n.innerHTML=`<span class="mr-2">🔍</span> Run Full System Audit`}})}var Q=document.getElementById(`app`);document.body.insertAdjacentHTML(`afterbegin`,`
...
`),n.APPS_SCRIPT_URL.includes(`YOUR_SCRIPT_ID`)&&(document.body.insertAdjacentHTML(`afterbegin`,`
  ...
  `),document.getElementById(`app`).style.marginTop=`48px`);var $=e=>t=>{Q.innerHTML=``,e(Q,t)};o.on(`/`,$(ee)).on(`/submit`,$(M)).on(`/find`,$(ce)).on(`/valid-list`,$(de)).on(`/final-list`,$(me)).on(`/withdraw`,$(_e)).on(`/results`,$(qe)).on(`/nominal-roll`,$(Je)).on(`/admin`,$(Ce)).on(`/admin/dashboard`,$(we)).on(`/admin/verify`,$(Te)).on(`/admin/withdrawals`,$(De)).on(`/admin/publish`,$(ke)).on(`/admin/posts`,$(Ae)).on(`/admin/ballots`,$(Ve)).on(`/admin/booths`,$(Ne)).on(`/admin/counting`,$(Fe)).on(`/admin/results-entry`,$(ze)).on(`/admin/results`,$(Ue)).on(`/admin/nominal-roll`,$(Z)).on(`/admin/schedule`,$($e)).on(`/admin/direct-nomination`,$(tt)).on(`/admin/testing`,$(He)).on(`/admin/audit`,$(nt)).setDefault(`/`),document.addEventListener(`click`,e=>{let t=e.target.closest(`[data-nav]`);t&&(e.preventDefault(),o.navigate(t.dataset.nav))}),o.start(),document.body.insertAdjacentHTML(`beforeend`,`
...
`),document.getElementById(`sync-status`),document.getElementById(`sync-icon`),document.getElementById(`sync-text`),h.initPublicData();